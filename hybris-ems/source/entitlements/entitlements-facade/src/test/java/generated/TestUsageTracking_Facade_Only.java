...
public class TestUsageTracking_Facade_Only
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("TestUsageTracking_Facade_Only-log");
			robotSettings.setOutputName("TestUsageTracking_Facade_Only-output");
			robotSettings.setReportName("TestUsageTracking_Facade_Only-report");
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS633-CJ/src/entitlements/entitlements-facade/src/test/resources/atdd/suites/UsageTracking_Facade_Only.txt"));
        }
	...
	@Test
	public void Test_TrackUsage_MeteredEntitlements_UseSingle_NoOverage()
	{
		final String robotTestName = "Test_TrackUsage_MeteredEntitlements_UseSingle_NoOverage";
	...
	@Test
	public void Test_TrackUsage_MeteredEntitlements_UseSingle_AllowOverage()
	{
		final String robotTestName = "Test_TrackUsage_MeteredEntitlements_UseSingle_AllowOverage";
	...
	@Test
	public void Test_TrackUsage_MeteredEntitlements_UseMulti_NoOverage()
	{
		final String robotTestName = "Test_TrackUsage_MeteredEntitlements_UseMulti_NoOverage";
	...
	@Test
	public void Test_TrackUsage_MeteredEntitlements_UseMulti_AllowOverage()
	{
		final String robotTestName = "Test_TrackUsage_MeteredEntitlements_UseMulti_AllowOverage";
	...
	@Test
	public void Test_TrackUsage_MeteredEntitlements_UseMulti_AllowOverage_TEST()
	{
		final String robotTestName = "Test_TrackUsage_MeteredEntitlements_UseMulti_AllowOverage_TEST";
