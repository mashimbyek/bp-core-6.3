...
public class TestMixedEntitlements_CreateAndCheck
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS633-CJ/src/entitlements/entitlements-facade/src/test/resources/atdd/suites/MixedEntitlements_CreateAndCheck.txt"));
        }
