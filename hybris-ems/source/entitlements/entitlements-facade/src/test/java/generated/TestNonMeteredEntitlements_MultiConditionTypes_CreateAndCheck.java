...
public class TestNonMeteredEntitlements_MultiConditionTypes_CreateAndCheck
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS633-CJ/src/entitlements/entitlements-facade/src/test/resources/atdd/suites/NonMeteredEntitlements_MultiConditionTypes_CreateAndCheck.txt"));
        }
