...
public class TestMixedEntitlements_UseAndCheckGrants
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS633-CJ/src/entitlements/entitlements-rest-client/src/test/resources/atdd/suites/MixedEntitlements_UseAndCheckGrants.txt"));
        }
