...
Pod::Spec.new do |s|
  s.name             = "yScanningLibrary"
  s.version          = "5.6"
  s.summary          = "Hybris Mobile [y] Scanning Library that contains SDK functionality to scan and interpret barcodes"
  s.description      = <<-DESC
                        Hybris Mobile [y] Scanning Library.
  ...
  s.source           = { :git => "https://stash.hybris.com/projects/MOBILE/repos/b2bios/browse/yScanningLibrary", :tag => s.version.to_s }
  s.platform     = :ios, '7.1'
  s.requires_arc = true
