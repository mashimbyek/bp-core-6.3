...
public class GroupCartModificationListPopulator implements Populator<AbstractOrderModel, List<CartModificationData>>
{
	...
	private Converter<AbstractOrderModel, AbstractOrderData> groupOrderEntryConverter;
	...
	protected List<OrderEntryData> getGroupedOrderEntries(final List<CartModificationData> modificationDataList)
	{
		...
		getGroupOrderEntryConverter().convert(null, holder);
	...
	protected Converter<AbstractOrderModel, AbstractOrderData> getGroupOrderEntryConverter()
	{
		return groupOrderEntryConverter;
	}

	@Required
	public void setGroupOrderEntryConverter(Converter<AbstractOrderModel, AbstractOrderData> groupOrderEntryConverter)
	{
