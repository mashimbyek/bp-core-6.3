 ...
 */
public class ProductReviewsPopulator<SOURCE extends ProductModel, TARGET extends ProductData> extends
		AbstractProductPopulator<SOURCE, TARGET>
{
	...
	{
		final List<CustomerReviewModel> reviews = getCustomerReviewService().getReviewsForProductAndLanguage(productModel,
				getCommonI18NService().getCurrentLanguage());
		productData.setReviews(getCustomerReviewConverter().convertAll(reviews));
