...
public class ProductBasicPopulatorTest
{
	...
	public void setUp()
	{
        ...
        when(configuratorSettingsService.getConfiguratorSettingsForProduct(any(ProductModel.class)))
                .thenAnswer(invocationOnMock -> {
						 final ProductModel product = (ProductModel) invocationOnMock.getArguments()[0];
						 if (CONFIGURABLE_PRODUCT_CODE.equals(product.getCode()))
						 {
							 return Collections.singletonList(new AbstractConfiguratorSettingModel());
						 }
						 else
						 {
		...
		productBasicPopulator.setConfiguratorSettingsService(configuratorSettingsService);
	}
