...
public class DefaultQuoteFacadeIntegrationTest extends BaseCommerceBaseTest
{
			...
			throws CommerceCartModificationException
	{
		...
		Assert.assertEquals("Cart attached to quote should be a newly created quote offer cart",
	...
	public void shouldRemoveQuoteCartAndSessionParam()
	{
		...
		Assert.assertNull("Quote Cart should be removed", commerceCartService.getCartForCodeAndUser(quoteCart.getCode(), user));
		Assert.assertNull("Quote should not have any cart attached", commerceQuoteService
				.getQuoteByCodeAndCustomerAndStore((CustomerModel) user, user, baseStore, quoteData.getCode()).getCartReference());
	}
