...
public class GroupOrderEntryPopulatorTest
{
	...
	public void shouldGroupEntries()
	{
		...
		originalEntries
				.add(createOrderEntry("productCode4", BASE_PRODUCT_2_PRICE_RANGE_TEST, MIN_PRICE_RANGE_TEST, TOTAL_PRICE_RANGE_TEST));
		originalEntries.add(
				createOrderEntry("productCode5", BASE_PRODUCT_2_PRICE_RANGE_TEST, MIN_PRICE_RANGE_TEST + 1, TOTAL_PRICE_RANGE_TEST));
		originalEntries
				.add(createOrderEntry("productCode6", BASE_PRODUCT_2_PRICE_RANGE_TEST, MAX_PRICE_RANGE_TEST, TOTAL_PRICE_RANGE_TEST));
