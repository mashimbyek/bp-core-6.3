...
public class OrderEntryPopulatorTest
{
	...
	private final AbstractPopulatingConverter<AbstractOrderEntryModel, OrderEntryData> entryConverter
			= new ConverterFactory<AbstractOrderEntryModel, OrderEntryData, OrderEntryPopulator>()
