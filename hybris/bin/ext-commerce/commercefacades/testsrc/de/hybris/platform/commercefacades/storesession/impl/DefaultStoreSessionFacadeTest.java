...
public class DefaultStoreSessionFacadeTest
{
	...
	public void setUp()
	{
		...
		given(currencyConverter.convertAll(Collections.singletonList(currencyModel))).willReturn(
				Collections.singletonList(currencyData));
	}
	...
	public void testGetAllSitesLanguages()
	{
		...
		given(languageConverter.convertAll(languageslist)).willReturn(Arrays.asList(new LanguageData(), new LanguageData()));
