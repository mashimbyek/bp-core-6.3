...
public class SearchResultProductConverterTest
{
	...
	public void testConvertEmpty()
	{
		...
		Assert.assertNull(result.getBaseProduct());
	}
	...
	public void testConvertBasics()
	{
		...
		map.put("baseProductCode", "base product code value");
		...
		Assert.assertEquals("base product code value", productData.getBaseProduct());
	}
