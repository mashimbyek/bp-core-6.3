...
public class DefaultCommercePromotionFacadeTest
{
	...
	public void setUp() throws Exception
	{
		...
		given(promotionsConverter.convertAll(productPromotionList)).willReturn(
				Arrays.asList(productPromotionData, productPromotionForGroupData));
		given(promotionsConverter.convertAll(orderPromotionList)).willReturn(
				Arrays.asList(orderPromotionData, orderPromotionForGroupData));
		given(promotionsConverter.convertAll(Collections.singletonList(orderPromotion))).willReturn(
				Collections.singletonList(orderPromotionData));
		given(promotionsConverter.convertAll(Collections.singletonList(productPromotion))).willReturn(
				Collections.singletonList(productPromotionData));
		given(promotionsConverter.convertAll(Collections.singletonList(orderPromotion))).willReturn(
				Collections.singletonList(orderPromotionData));
		given(promotionsConverter.convertAll(Collections.singletonList(productPromotionForGroup))).willReturn(
				Collections.singletonList(productPromotionForGroupData));
		given(promotionsConverter.convertAll(Collections.singletonList(orderPromotionForGroup))).willReturn(
				Collections.singletonList(orderPromotionForGroupData));
