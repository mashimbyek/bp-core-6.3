...
public class PromotionVoucherTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROMOTIONVOUCHERCODE = "vo2";
	...
	private void placeVoucherOrder(final ProductModel product, final boolean successful)
			throws InvalidCartException, JaloPriceFactoryException
	{
