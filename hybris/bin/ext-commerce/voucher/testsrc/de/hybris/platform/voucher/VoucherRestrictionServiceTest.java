...
public class VoucherRestrictionServiceTest extends AbstractVoucherServiceTest
{
	...
	private void prepareData()
	{
		...
		final UserModel userDemo = userService.getUserForUID("demo");
	...
	private void testIsFulfilledOrder(final String productCode, final String categoryCode1, final String categoryCode2)
	{
		...
		final CategoryModel category1 = categoryService.getCategoryForCode(categoryCode1);
		final CategoryModel category2 = categoryService.getCategoryForCode(categoryCode2);
