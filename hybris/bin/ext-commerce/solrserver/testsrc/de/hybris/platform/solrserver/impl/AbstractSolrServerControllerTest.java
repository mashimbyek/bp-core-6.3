...
public class AbstractSolrServerControllerTest
{
	...
	public void startServer() throws Exception
	{
		...
		doReturn(commandResult).when(solrServerController).callSolrCommand(solrInstance, AbstractSolrServerController.SOLR_START_COMMAND,
				true);
	...
	public void restartRunningServer() throws Exception
	{
		...
		doReturn(commandResult).when(solrServerController).callSolrCommand(solrInstance, AbstractSolrServerController.SOLR_START_COMMAND,
				true);
		doReturn(commandResult).when(solrServerController).callSolrCommand(solrInstance, AbstractSolrServerController.SOLR_STOP_COMMAND,
				true);
	...
	public void statusShouldBeStopped() throws Exception
	{
		...
		doReturn(commandResult).when(solrServerController).callSolrCommand(solrInstance,
				AbstractSolrServerController.SOLR_STATUS_COMMAND, false);
