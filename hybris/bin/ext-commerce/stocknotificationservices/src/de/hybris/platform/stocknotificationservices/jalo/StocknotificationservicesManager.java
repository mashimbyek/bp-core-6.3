...
/**
 * This is the extension manager of the Stocknotificationservices extension.
 */
public class StocknotificationservicesManager extends GeneratedStocknotificationservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(StocknotificationservicesManager.class);
	 ...
	 */
	public static StocknotificationservicesManager getInstance()
	{
		return (StocknotificationservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(StocknotificationservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StocknotificationservicesManager() // NOPMD 
	{
		LOG.debug("constructor of StocknotificationservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of StocknotificationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of StocknotificationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
