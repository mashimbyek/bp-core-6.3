...
import de.hybris.platform.ruleengine.versioning.DroolsKieModuleVersionResolver;
...
public class DroolsModuleVersioningServiceUnitTest
{
	...
	public void setUp()
	{
		...
		when(ruleEngineService.getRuleModuleForRule(rule)).thenReturn(kieModule);
	...
	public void testGetDeployedModuleVersionOk() throws Exception
	{
		...
		final Optional<Long> deployedModuleVersion =  moduleVersioningService.getDeployedModuleVersionForRule(RULE_CODE);
	...
	public void testGetDeployedModuleVersionIllegalVersion() throws Exception
	{
		...
		moduleVersioningService.getDeployedModuleVersionForRule(RULE_CODE);
	}
	...
	public void testAssertRuleModuleVersion() throws Exception
	{
		...
		moduleVersioningService.assertRuleModuleVersion(rule);
