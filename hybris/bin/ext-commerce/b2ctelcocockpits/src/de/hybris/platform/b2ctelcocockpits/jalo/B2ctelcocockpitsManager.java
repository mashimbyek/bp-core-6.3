...
*
*/
package de.hybris.platform.b2ctelcocockpits.jalo;
...
import de.hybris.platform.b2ctelcocockpits.constants.B2ctelcocockpitsConstants;



/**
 * This is the extension manager of the B2ctelcocockpits extension.
 */
public class B2ctelcocockpitsManager extends GeneratedB2ctelcocockpitsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcocockpitsManager.class.getName());
	 ...
	 */
	public static B2ctelcocockpitsManager getInstance()
	{
		return (B2ctelcocockpitsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcocockpitsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2ctelcocockpitsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcocockpitsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcocockpitsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcocockpitsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
