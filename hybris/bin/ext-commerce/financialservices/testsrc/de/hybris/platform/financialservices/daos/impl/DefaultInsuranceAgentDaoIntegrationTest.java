...
public class DefaultInsuranceAgentDaoIntegrationTest extends ServicelayerTest
{
	...
	public void getAgentByEmptyUidTest()
	{
		...
		thrown.expectMessage(
				"No result for the given example [AgentModel (<unsaved>)] was found. Searched with these attributes: {uid=}");
	...
	public void getAgentsByWrongCategoryCodeTest()
	{
		...
		Assert.assertNotNull(allAgents);
		Assert.assertTrue("Category with code='" + AGENT_CATEGORY_NAME + "' does not exist! Empty List should be returned!",
				allAgents.isEmpty());
	}
