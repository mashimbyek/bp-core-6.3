...
public class DefaultPropertyQuotationService extends AbstractQuotationService
{
	...
	protected Map<String, String> populateCommonProperties(final InsuranceQuoteModel quote)
	{
		...
		if (quote != null && MapUtils.isNotEmpty(quote.getProperties()))
		{
			...
			property.put(FinancialservicesConstants.PROPERTY_DETAILS_IS_STANDARD_50000_CONTENT_COVER,
					MapUtils.getString(quote.getProperties(),
							FinancialservicesConstants.PROPERTY_DETAILS_IS_STANDARD_50000_CONTENT_COVER, StringUtils.EMPTY));
			property.put(FinancialservicesConstants.PROPERTY_DETAILS_CONTENT_COVER_MULTIPLE_OF_10000,
					MapUtils.getString(quote.getProperties(),
							FinancialservicesConstants.PROPERTY_DETAILS_CONTENT_COVER_MULTIPLE_OF_10000, StringUtils.EMPTY));
