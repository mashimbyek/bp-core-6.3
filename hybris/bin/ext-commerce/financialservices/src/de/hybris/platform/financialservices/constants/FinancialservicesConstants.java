...
public final class FinancialservicesConstants extends GeneratedFinancialservicesConstants
{
	...
	public static final String LIFE_WHO_COVERED = "lifeWhoCovered";
	public static final String LIFE_COVERAGE_REQUIRE = "lifeCoverageRequire";
	public static final String LIFE_COVERAGE_EACH_MONTH = "lifeCoverageEachMonth";
	public static final String LIFE_COVERAGE_LAST = "lifeCoverageLast";
	public static final String LIFE_COVERAGE_START_DATE = "lifeCoverageStartDate";
	public static final String LIFE_MAIN_DOB = "lifeMainDob";
	public static final String LIFE_MAIN_SMOKE = "lifeMainSmoke";
	public static final String LIFE_SECOND_DOB = "lifeSecondDob";
	public static final String LIFE_SECOND_SMOKE = "lifeSecondSmoke";
	public static final String LIFE_RELATIONSHIP = "lifeRelationship";
