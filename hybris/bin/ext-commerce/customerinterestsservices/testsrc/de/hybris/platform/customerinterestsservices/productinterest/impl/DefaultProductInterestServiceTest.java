...
public class DefaultProductInterestServiceTest
{
	...
	@Test
	public void test_Remove_Product_Interest_By_Product()
	{
		...
		productInterestService.removeProductInterestByProduct("1111111");
	...
	public void test_Get_Products_By_Customer_Interests()
	{
		...
		Map<ProductModel, Map<NotificationType, Date>> productMap = productInterestService
	...
	public void test_Get_Products_Count_By_Customer_Interests()
	{
		...
		Mockito.doReturn(expectedCount).when(productInterestDao).findProductsCountByCustomerInterests(Mockito.any(), Mockito.any(),
				Mockito.any(), Mockito.any());
		int acturalCount = productInterestService.getProductsCountByCustomerInterests(new PageableData());
