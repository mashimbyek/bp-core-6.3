...
/**
 * This is the extension manager of the Customerinterestsservices extension.
 */
public class CustomerinterestsservicesManager extends GeneratedCustomerinterestsservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CustomerinterestsservicesManager.class);
	 ...
	 */
	public static CustomerinterestsservicesManager getInstance()
	{
		return (CustomerinterestsservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustomerinterestsservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerinterestsservicesManager() // NOPMD 
	{
		LOG.debug("constructor of CustomerinterestsservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CustomerinterestsservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CustomerinterestsservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
