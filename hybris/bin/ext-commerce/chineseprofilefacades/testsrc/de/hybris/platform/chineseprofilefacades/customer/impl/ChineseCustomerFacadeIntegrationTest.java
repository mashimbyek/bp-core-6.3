...
import de.hybris.platform.chineseprofilefacades.customer.impl.ChineseCustomerFacade;
...
public class ChineseCustomerFacadeIntegrationTest extends ServicelayerTransactionalTest
{
	...
	private String key = "VerificationData";
	...
	{
		boolean flag = customerFacade.isMobileNumberUnique("13512345678");
