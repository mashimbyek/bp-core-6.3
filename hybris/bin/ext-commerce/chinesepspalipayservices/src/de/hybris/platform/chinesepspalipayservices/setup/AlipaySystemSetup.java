 ...
 */
package de.hybris.platform.chinesepspalipayservices.setup;
...
@SystemSetup(extension = ChinesepspalipayservicesConstants.EXTENSIONNAME)
public class AlipaySystemSetup extends AbstractSystemSetup
{


	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AlipaySystemSetup.class);
	...
	public List<SystemSetupParameter> getInitializationOptions()
	{
		...
		params.add(createBooleanSystemSetupParameter(IMPORT_CORE_DATA, "Import Alipay Data", true));
		return params;
	}
	...
	protected void importCommonData(final String extensionName)
	{
		...
		getSetupImpexService().importImpexFile(String.format("/%s/import/essential/alipay.impex", extensionName), false);
	}
