		...
		implements AlipayPaymentTransactionEntryDao
{
	...
	@Override
	public List<AlipayPaymentTransactionEntryModel> findPaymentTransactionEntryByTypeAndStatus(PaymentTransactionType capture,
			TransactionStatus status, AlipayPaymentTransactionModel alipayPaymentTransaction)
	{
		...
		FlexibleSearchQuery query = new FlexibleSearchQuery(FIND_ENTRY_BY_TYPE_STATUS_QUERY);
