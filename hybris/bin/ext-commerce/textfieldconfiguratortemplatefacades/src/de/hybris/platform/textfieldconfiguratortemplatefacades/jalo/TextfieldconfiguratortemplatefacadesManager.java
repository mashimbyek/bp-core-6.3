...
public class TextfieldconfiguratortemplatefacadesManager extends GeneratedTextfieldconfiguratortemplatefacadesManager
{
	...
	{
		return (TextfieldconfiguratortemplatefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TextfieldconfiguratortemplatefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplatefacadesManager() // NOPMD NOSONAR
	{
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TextfieldconfiguratortemplatefacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
