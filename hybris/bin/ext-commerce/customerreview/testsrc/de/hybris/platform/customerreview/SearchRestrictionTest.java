...
public class SearchRestrictionTest extends ServicelayerTest
{
	...
	public void searchRestrictionTest()
	{
		...
		// customerReviewService.getReviewsForCustomer should work correctly and be restricted
		assertEquals(INVALID_NUMBER_OF_CUSTOMER_REVIEWS, 1, customerReviewService.getReviewsForCustomer(user).size());
