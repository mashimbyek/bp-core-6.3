...
/**
 * This is the extension manager of the Stocknotificationfacades extension.
 */
public class StocknotificationfacadesManager extends GeneratedStocknotificationfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(StocknotificationfacadesManager.class);
	 ...
	 */
	public static StocknotificationfacadesManager getInstance()
	{
		return (StocknotificationfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(StocknotificationfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StocknotificationfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of StocknotificationfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of StocknotificationfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of StocknotificationfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
