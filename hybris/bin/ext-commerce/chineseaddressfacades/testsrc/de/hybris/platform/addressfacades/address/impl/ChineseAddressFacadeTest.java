...
public class ChineseAddressFacadeTest
{
	...
	public void testGetCitiesForRegion()
	{
		...
		List<CityData> cityDataListActual = chineseAddressFacade.getCitiesForRegion(CITY_ISO_CODE);

		List<CityData> expectedCityDataList = new ArrayList<>();
	...
	public void testGetDistrictsForCity()
	{
		...
		List<DistrictData> districtDataListActual = chineseAddressFacade.getDistrictsForCity(DISTRICT_ISO_CODE);

		List<DistrictData> expectedDistrictDataList = new ArrayList<>();
