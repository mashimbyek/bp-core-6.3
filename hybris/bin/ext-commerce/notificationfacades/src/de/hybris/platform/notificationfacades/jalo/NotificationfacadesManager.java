...
/**
 * This is the extension manager of the Notificationfacades extension.
 */
public class NotificationfacadesManager extends GeneratedNotificationfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(NotificationfacadesManager.class);
	 ...
	 */
	public static NotificationfacadesManager getInstance()
	{
		return (NotificationfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(NotificationfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NotificationfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of NotificationfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of NotificationfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of NotificationfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
