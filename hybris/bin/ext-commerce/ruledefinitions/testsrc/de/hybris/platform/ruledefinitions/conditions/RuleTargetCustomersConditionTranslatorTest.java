...
public class RuleTargetCustomersConditionTranslatorTest
{
	...
	public void setUp()
	{
		...
		when(parameters.get(RuleTargetCustomersConditionTranslator.CUSTOMER_GROUPS_OPERATOR_PARAM))
				.thenReturn(customerGroupsOperatorParameter);
	...
	@Test
	public void testTranslateCustomersParamNull() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateNotOperatorCustomerCondition() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateAnyOperatorCondition() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateAnyOperatorWithExcludedCondition() throws RuleCompilerException
	{
		when(customerGroupsOperatorParameter.getValue()).thenReturn(CollectionOperator.CONTAINS_ANY);
		...
		checkExcludeCustomerCondition(irGroupCondition.getChildren().get(3));
		final RuleIrGroupCondition ruleIrGroupCondition = (RuleIrGroupCondition) irGroupCondition.getChildren().get(2);
		final List<RuleIrCondition> groupConditions = ruleIrGroupCondition.getChildren();
		assertThat(groupConditions.get(0), instanceOf(RuleIrGroupCondition.class));
		final RuleIrGroupCondition irCustomerGroupsCondition = (RuleIrGroupCondition) groupConditions.get(0);
	...
	private void checkExcludeCustomerCondition(final RuleIrCondition ruleIrCondition)
	{
		...
		assertEquals(USER_RAO_ID_ATTRIBUTE, irExcludedCustomersCondition.getAttribute());
	...
	@Test
	public void testTranslateAllOperatorCondition() throws RuleCompilerException
	{
