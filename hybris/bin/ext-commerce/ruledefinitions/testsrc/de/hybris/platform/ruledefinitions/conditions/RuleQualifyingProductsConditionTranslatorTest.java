...
public class RuleQualifyingProductsConditionTranslatorTest
{
	...
	public void setUp()
	{
		...
		when(parameters.get(RuleQualifyingProductsConditionTranslator.PRODUCTS_OPERATOR_PARAM))
				.thenReturn(productsOperatorParameter);
	...
	@Test
	public void testTranslateProductsOperatorParamNull() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateProductsParamNull() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateNotOperatorCondition() throws RuleCompilerException
	{
