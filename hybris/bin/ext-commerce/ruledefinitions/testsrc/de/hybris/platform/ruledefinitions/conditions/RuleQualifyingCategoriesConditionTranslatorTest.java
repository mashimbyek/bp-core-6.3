...
public class RuleQualifyingCategoriesConditionTranslatorTest
{
	...
	@Test
	public void testTranslateCategoriesOperatorParamNull() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateCategoriesParamNull() throws RuleCompilerException
	{
	...
	@Test
	public void testTranslateAnyOperatorWithExcludeCategoryCondition() throws RuleCompilerException
	{
		when(categoriesOperatorParameter.getValue()).thenReturn(CollectionOperator.CONTAINS_ANY);
