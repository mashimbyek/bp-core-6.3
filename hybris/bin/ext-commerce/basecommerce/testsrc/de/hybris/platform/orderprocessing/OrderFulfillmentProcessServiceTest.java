...
public class OrderFulfillmentProcessServiceTest extends AbstractOrderManagementTest
{
	...
	public void testStartFulfillmentProcess() throws Exception
	{
		...
		final OrderProcessModel process = orderFulfillmentProcessService.startFulfillmentProcessForOrder(getOrder());
		process.getCode();
		...
		Assert.assertEquals("Order related to process is not as expected", getOrder(), ((OrderProcessModel) bussinessProcess).getOrder());
