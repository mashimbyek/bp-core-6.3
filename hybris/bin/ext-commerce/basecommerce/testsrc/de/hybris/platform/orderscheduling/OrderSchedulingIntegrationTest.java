...
public class OrderSchedulingIntegrationTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		...
		final UserModel sessionUser = userService.getCurrentUser();
	...
	public void testOneToManyRelationCloning()
	{
		...
		Assert.assertFalse(
				typeService.getAttributeDescriptor(CartModel._TYPECODE, CartModel.CARTTOORDERCRONJOB).getPartOf().booleanValue());
