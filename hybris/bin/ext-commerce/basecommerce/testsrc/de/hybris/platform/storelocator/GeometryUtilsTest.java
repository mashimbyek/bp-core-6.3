...
public class GeometryUtilsTest
{
	...
	private Double getDistanceInKilometresForCorner(final GPS point, final GlobalPosition start)
	{
		...
		final GeodeticMeasurement measurementForFirstCorner = getGeodeticCalculator().calculateGeodeticMeasurement(
	...
	protected GeodeticCalculator getGeodeticCalculator()
	{
