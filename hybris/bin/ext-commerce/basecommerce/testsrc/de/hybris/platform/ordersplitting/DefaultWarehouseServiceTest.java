...
{
	@InjectMocks
	private final DefaultWarehouseService defaultWarehouseService = new DefaultWarehouseService();
	...
	public void testGetWarehousesWithProductsInStock()
	{
		...
		Mockito.when(warehouseDao.getWarehousesWithProductsInStock(entry.getProduct().getCode(), entry.getQuantity().longValue(),
	...
	public void testGetWarehousesWithProductsInStockDefault()
	{
		...
		Mockito.when(warehouseDao.getWarehousesWithProductsInStock(product1.getCode(), entry.getQuantity().longValue(),
