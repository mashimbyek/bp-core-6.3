...
import de.hybris.platform.chinesetaxinvoicefacades.facades.impl.ChineseTaxInvoiceCheckoutFacade;
...
public class ChineseTaxInvoiceCheckoutFacadeTest
{
	...
	public void prepare()
	{
		...
		taxInvoiceCheckoutFacade.setTaxInvoiceReversePopulator(taxInvoiceReversePopulator);
	...
	public void testSetTaxInvoice()
	{
		...
		doNothing().when(taxInvoiceReversePopulator).populate(taxInvoiceData, taxInvoiceModel);
