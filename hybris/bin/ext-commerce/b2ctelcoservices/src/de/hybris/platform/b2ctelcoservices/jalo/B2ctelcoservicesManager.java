...
/**
 * This is the extension manager of the B2ctelcoservices extension.
 */
public class B2ctelcoservicesManager extends GeneratedB2ctelcoservicesManager
{
	 ...
	 */
	public static B2ctelcoservicesManager getInstance()
	{
		return (B2ctelcoservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcoservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2ctelcoservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcoservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcoservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcoservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
