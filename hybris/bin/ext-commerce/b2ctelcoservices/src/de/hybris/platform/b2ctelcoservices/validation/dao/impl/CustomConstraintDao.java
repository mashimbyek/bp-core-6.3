 ...
 * {@link de.hybris.platform.b2ctelcoservices.jalo.ClassificationNotBlankConstraint} per target (= type
 * to be checked). As the {@link de.hybris.platform.b2ctelcoservices.jalo.ClassificationNotBlankConstraint}
 * inherits from TypeConstraint the DefaultConstraintDao
 * would select the constraints by the attributes target, annotation and active only. But the
 * {@link de.hybris.platform.b2ctelcoservices.jalo.ClassificationNotBlankConstraint}s need to have
 * the additional attributes category and classification to be
 * unique.
 */
