...
public class DefaultBundleTemplateServiceNestedIntegrationTest extends ServicelayerTest
{
    ...
    @Resource(name = "acceleratorCheckoutService")
    private DefaultBundleCheckoutService checkoutService;
    ...
    @Test
    public void shouldKnowWhetherBundleIsUsedByOrder() throws CommerceCartModificationException
    {
        final CatalogVersionModel catalog = getCatalog();
        final BundleTemplateModel component = getBundleTemplateByIdAndCatalogVersion(REGULAR_COMPONENT, catalog);
        final BundleTemplateModel parent = component.getParentTemplate();
        ...
        List<CommerceCartModification> errors = checkoutService.consolidateCheckoutCart(cart, pos);
