...
public class FindBundlePricingWithCurrentPriceFactoryStrategyTest
{
	...
	private ProductModel subscriptionProduct;
	...
	public void setUp() throws Exception
	{
		...
		when(subscriptionProductService.isSubscription(any(ProductModel.class))).thenAnswer(invocationOnMock -> {
		...
		bundlePriceFactory.setSubscriptionProductService(subscriptionProductService);
		...
		subscriptionProduct = mock(ProductModel.class);
