...
/**
 * The class of BillingTimeDataComparator. Sorting rules </br>
 * if the BillingTime code matches either the top or bottom attribute values, then the order of the items affected
 * respectively </br>
 * if the top/bottom codes do not match the BillingTime code, then the comparison is based on the BilingTime names
 */
