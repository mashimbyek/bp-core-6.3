...
package de.hybris.platform.financialfacades.jalo;
...
/**
 * This is the extension manager of the Financialfacades extension.
 */
public class FinancialfacadesManager extends GeneratedFinancialfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FinancialfacadesManager.class.getName());
	 ...
	 */
	public static FinancialfacadesManager getInstance()
	{
		return (FinancialfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(FinancialfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FinancialfacadesManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FinancialfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FinancialfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FinancialfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
