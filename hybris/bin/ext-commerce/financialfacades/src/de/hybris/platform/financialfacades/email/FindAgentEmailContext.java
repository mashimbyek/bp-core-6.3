...
{
	private final Logger LOG = Logger.getLogger(FindAgentEmailContext.class);
	...
	@Override
	protected CustomerModel getCustomer(final FindAgentEmailProcessModel businessProcessModel)
	{
