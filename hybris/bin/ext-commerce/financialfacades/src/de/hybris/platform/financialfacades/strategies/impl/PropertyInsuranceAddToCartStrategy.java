...
public class PropertyInsuranceAddToCartStrategy extends AbstractInsuranceAddToCartStrategy
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see de.hybris.platform.financialacceleratorstorefront.strategies.impl.AbstractInsuranceAddToCartStrategy#
	 * addToCartInternal (java.util.Map)
	 */
	@Override
	...
	protected void populateInsuranceDetailsInformation(final InsuranceQuoteModel quoteModel) throws YFormServiceException
	{
		...
		final String propertyIsStandard50000ContentCover = getSessionService()
				.getAttribute(FinancialfacadesConstants.PROPERTY_DETAILS_IS_STANDARD_50000_CONTENT_COVER);
		final String propertyRebuildCost = getSessionService()
				.getAttribute(FinancialfacadesConstants.PROPERTY_DETAILS_REBUILD_COST);
		final String propertyMultipleOf10000ContentCover = getSessionService()
				.getAttribute(FinancialfacadesConstants.PROPERTY_DETAILS_CONTENT_COVER_MULTIPLE_OF_10000);
