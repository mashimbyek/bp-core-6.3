...
public class DefaultCustomerInsurancePolicyStrategy implements CustomerInsurancePolicyStrategy
{
	...
	/**
	 * This method is used to generate a list (order being important for visual results) of
	 * <InsurancePolicyListingData> DTO beans from a collection of <OrderModel> beans.
	 *
	 * @param orders
