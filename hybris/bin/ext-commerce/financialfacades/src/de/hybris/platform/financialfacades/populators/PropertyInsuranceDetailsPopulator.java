...
public class PropertyInsuranceDetailsPopulator extends AbstractInsuranceDetailsPopulator
{
	...
	public void populate(final YFormDataData yFormDataData, final InsurancePolicyData detailData) throws ConversionException
	{
		...
		if (yFormDataData.getContent() != null)
		{
			...
			policyHolderDetail
					.setPreferredContactNumber(getTextValue(xpath, document, XPATH_PERSONAL_DETAIL + "/preferred-contact-number"));

			policyHolderDetail.setPropertyCorrespondenceAddress(
					getTextValue(xpath, document, XPATH_PERSONAL_DETAIL + "/property-correspondance-address"));
