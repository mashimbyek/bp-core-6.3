...
public class DefaultProductQuotationPricePopulator<SOURCE extends ProductModel, TARGET extends ProductData>
		extends SubscriptionProductPricePlanPopulator<SOURCE, TARGET>
{
	...
	protected void populatePriceData(final TARGET target, final SubscriptionPricePlanData pricePlanData)
	{
		...
		final QuotationRequestData quotationRequestData = quotationService
				.createQuotationRequestData(pricePlan.getQuotationProvider(), target.getCode(), null);
