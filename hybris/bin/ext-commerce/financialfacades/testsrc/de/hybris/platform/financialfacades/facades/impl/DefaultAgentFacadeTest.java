...
public class DefaultAgentFacadeTest
{
	...
	{
		given(categoryService.getCategoryForCode(UNEXISTING_CATEGORY_CODE))
				.willThrow(new UnknownIdentifierException("Category with code '" + UNEXISTING_CATEGORY_CODE + "' not found! "));
	...
	{
		given(categoryService.getCategoryForCode(""))
				.willThrow(new UnknownIdentifierException("Category with code '' not found! "));
	...
	{
		given(categoryService.getCategoryForCode(null)).willThrow(new IllegalArgumentException(NULL_CATEGORY_CODE_MESSAGE));
