...
/**
 * Tests for the
 * {@link de.hybris.platform.financialacceleratorstorefront.strategies.impl.ContactExpertYFormPreprocessorStrategy}.
 */
@UnitTest
public class ContactExpertYFormPreprocessorStrategyTest
{
	...
	private static final String EXPECTED_XML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><form><contact-expert><agent>"
			+ AGENT_VALUE + "</agent><name/><email-address/><phone/><call-back/><interest/><message/></contact-expert></form>";
