...
import de.hybris.platform.acceleratorfacades.cartfileupload.SavedCartFileUploadProcessIntegrationTest;
import de.hybris.platform.impex.jalo.ImpExException;
import de.hybris.platform.warehousing.constants.WarehousingTestConstants;


/**
 * Re-implements test {@link SavedCartFileUploadProcessIntegrationTest} to provide missing information required when warehousing extensions is present
 */
@IntegrationTest(replaces = SavedCartFileUploadProcessIntegrationTest.class)
public class OrderManagementSavedCartFileUploadTest extends SavedCartFileUploadProcessIntegrationTest
{
	@Override
