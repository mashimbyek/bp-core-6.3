...
/**
 * Re-implements test {@link DefaultCommerceCartServiceIntegrationTest} to provide missing information required when warehousing extensions is present
 */
@IntegrationTest(replaces = DefaultCommerceCartServiceIntegrationTest.class)
public class OrderManagementCommerceCartServiceIntegrationTest extends DefaultCommerceCartServiceIntegrationTest
{
	@Override
