...
/**
 * Re-implements test {@link DefaultCartFacadeIntegrationTest} to provide missing information required when warehousing extensions is present
 */
@IntegrationTest(replaces = DefaultCartFacadeIntegrationTest.class)
public class OrderManagementCartFacadeIntegrationTest extends DefaultCartFacadeIntegrationTest
{
	@Override
