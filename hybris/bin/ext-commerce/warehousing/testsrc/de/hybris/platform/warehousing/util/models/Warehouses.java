...
public class Warehouses extends AbstractItems<WarehouseModel>
{
	...
	public static final String CODE_MONTREAL_EXTERANL = "montrealExternal";
	...
	{
		return getFromCollectionOrSaveAndReturn(() -> getWarehouseDao().getWarehouseForCode(CODE_MONTREAL_EXTERANL),
				() -> WarehouseModelBuilder.fromModel(Default())
						.withCode(CODE_MONTREAL_EXTERANL)
						.withName(CODE_MONTREAL_EXTERANL, Locale.ENGLISH)
						.withDeliveryModes(getDeliveryModes().Pickup(), getDeliveryModes().Regular())
						.withExternal(true)
						.build());
	}
