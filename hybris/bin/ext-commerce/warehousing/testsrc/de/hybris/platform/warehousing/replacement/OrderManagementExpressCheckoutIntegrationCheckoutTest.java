...
public class OrderManagementExpressCheckoutIntegrationCheckoutTest extends DefaultExpressCheckoutIntegrationCheckoutTest
{
	@Override
	...
	{
		importCsv("/warehousing/test/impex/replacement/replacement-express-checkout-test-data.impex", WarehousingTestConstants.ENCODING);
