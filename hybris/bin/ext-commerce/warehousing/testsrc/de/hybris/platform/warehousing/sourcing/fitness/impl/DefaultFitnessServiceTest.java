...
public class DefaultFitnessServiceTest
{
	...
	public void setUp()
	{
		...
		when(sourcingFactorFactory.getAllSourcingFactors()).thenReturn(factors);
	...
	@Test
	public void shouldCalculateFitness_SingleFactor_100PercentDeprecatedApi()
	{
	...
	@Test
	public void shouldCalculateFitness_SingleFactor_50PercentDeprecatedApi()
	{
		when(factor1.getWeight()).thenReturn(FIFTY);
		when(factor2.getWeight()).thenReturn(ZERO);
	...
	@Test
	public void shouldCalculateFitness_MultipleFactors_0PercentDeprecatedApi()
	{
		when(factor1.getWeight()).thenReturn(ZERO);
		when(factor2.getWeight()).thenReturn(ZERO);
	...
	@Test
	public void shouldCalculateFitness_MultipleFactors_50PercentDeprecatedApi()
	{
		when(factor1.getWeight()).thenReturn(FIFTY);
		when(factor2.getWeight()).thenReturn(FIFTY);
	...
	@Test
	public void shouldSortResultsByFittestDeprecatedApi()
	{
		when(factor1.getWeight()).thenReturn(ONE_HUNDRED);
		when(factor2.getWeight()).thenReturn(ZERO);
