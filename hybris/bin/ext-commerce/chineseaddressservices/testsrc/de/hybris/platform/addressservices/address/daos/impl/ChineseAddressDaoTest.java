...
public class ChineseAddressDaoTest extends ServicelayerTransactionalTest
{
	...
	{
		List<CityModel> cities = chineseAddressDao.getCitiesForRegion(REGION_ISOCODE);
	...
	{
		CityModel cityTest = chineseAddressDao.getCityForIsocode(CITY_ISOCODE);
	...
	{
		DistrictModel district = chineseAddressDao.getDistrictForIsocode(DISTRICT_ISOCODE1);
	...
	{
		List<DistrictModel> districts = new ArrayList<>(chineseAddressDao.getDistrictsForCity(CITY_ISOCODE));
