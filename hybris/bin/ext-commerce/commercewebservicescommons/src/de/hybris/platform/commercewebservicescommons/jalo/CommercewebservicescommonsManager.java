...
public class CommercewebservicescommonsManager extends GeneratedCommercewebservicescommonsManager
{
	 ...
	 */
	public CommercewebservicescommonsManager() // NOPMD 
	{
	...
	{
		return (CommercewebservicescommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CommercewebservicescommonsConstants.EXTENSIONNAME);
	}
