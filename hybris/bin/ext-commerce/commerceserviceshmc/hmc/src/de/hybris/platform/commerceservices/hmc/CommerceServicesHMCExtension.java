...
/**
 * Provides necessary meta information about the CommerceServices hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class CommerceServicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CommerceServicesHMCExtension.class);

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.commerceservices.hmc.locales";
