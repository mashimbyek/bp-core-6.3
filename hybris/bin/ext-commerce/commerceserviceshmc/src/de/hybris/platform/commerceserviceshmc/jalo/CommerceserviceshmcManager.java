 ...
 */
package de.hybris.platform.commerceserviceshmc.jalo;
...
import de.hybris.platform.commerceserviceshmc.constants.CommerceserviceshmcConstants;



/**
 * This is the extension manager of the Commerceserviceshmc extension.
 */
public class CommerceserviceshmcManager extends GeneratedCommerceserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CommerceserviceshmcManager.class.getName());
	 ...
	 */
	public static CommerceserviceshmcManager getInstance()
	{
		return (CommerceserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CommerceserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CommerceserviceshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CommerceserviceshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CommerceserviceshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CommerceserviceshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
