...
public class DeviceBundleTabsPopulatorIntegrationTest extends ServicelayerTest
{
	...
	public void setUp() throws Exception
	{
		...
		importCsv("/b2ctelcofacades/test/testBundleTemplateExtrasBundleBoxesPopulator.impex", "utf-8");
			...
			final Double expOtherBundleProductPrice)
	{
		...
		for (final FrequencyTabData freqTab : freqTabData)
		{
			...
			{
				freqTabCounter++;
				assertFalse("", freqTab.isPreselected());
				...
				for (final ProductData plan : freqTab.getProducts())
				{
					if (planCode.equals(plan.getCode()))
					{
						...
						assertFalse("", plan.isPreselected());
					}
				}
			}
		}
