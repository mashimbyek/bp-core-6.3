 ...
 *
 * @param <SOURCEPRODUCT> source product class
 * @param <TARGETPRODUCT> target product class
 * @param <SOURCETEMPLATE> template class
 */
public class SubscriptionProductBundleTabsPopulator<SOURCEPRODUCT extends ProductModel,
