...
import de.hybris.platform.b2ctelcofacades.data.DashboardBoxData;
import de.hybris.platform.b2ctelcofacades.data.DashboardBoxEntryData;
import de.hybris.platform.b2ctelcofacades.data.DashboardData;
import de.hybris.platform.b2ctelcofacades.data.DashboardPopulatorParameters;
		...
		Populator<SOURCE, TARGET>
{
	...
	protected List<DashboardBoxData> mergeTelcoSpecificBoxes(final List<DashboardBoxData> dashboardBoxes)
	{
		...
		final List<String> types = dashboardBoxes.stream()
				.map(dashboardBoxData -> dashboardBoxData.getMainComponent().getType())
		...
		{
			final List<DashboardBoxEntryData> mergedEntries = new ArrayList<>();
