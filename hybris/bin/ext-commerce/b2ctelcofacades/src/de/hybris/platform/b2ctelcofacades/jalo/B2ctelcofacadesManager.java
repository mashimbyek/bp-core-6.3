...
*
*/
package de.hybris.platform.b2ctelcofacades.jalo;
...
/**
 * This is the extension manager of the B2ctelcofacades extension.
 */
public class B2ctelcofacadesManager extends GeneratedB2ctelcofacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcofacadesManager.class.getName());
	 ...
	 */
	public static B2ctelcofacadesManager getInstance()
	{
		return (B2ctelcofacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcofacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public B2ctelcofacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcofacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcofacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcofacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
