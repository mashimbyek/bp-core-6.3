...
public class DefaultBoostServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void setUp() throws Exception
	{
		...
		importService.importData(new StreamBasedImpExResource(
				SolrfacetsearchDataSetup.class.getResourceAsStream("/test/impex/common/essential-data.impex"),
				CSVConstants.HYBRIS_ENCODING, Character.valueOf(';')));

		importService.importData(
				new StreamBasedImpExResource(SolrfacetsearchDataSetup.class.getResourceAsStream("/test/impex/catalog.impex"),
						CSVConstants.HYBRIS_ENCODING, Character.valueOf(';')));
		importService
				.importData(new StreamBasedImpExResource(SolrfacetsearchDataSetup.class.getResourceAsStream("/test/impex/solr.impex"),
						CSVConstants.HYBRIS_ENCODING, Character.valueOf(';')));
