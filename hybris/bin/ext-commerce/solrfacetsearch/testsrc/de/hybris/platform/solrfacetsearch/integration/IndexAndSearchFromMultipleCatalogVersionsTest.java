...
public class IndexAndSearchFromMultipleCatalogVersionsTest extends AbstractIntegrationTest
{
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInTwoCatalogVersions()
			throws IndexerException, FacetConfigServiceException, FacetSearchException
	{
		// given
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInOneCatalogVersion()
			throws FacetConfigServiceException, IndexerException, FacetSearchException
	{
		// given
		final FacetSearchConfig facetSearchConfig = getFacetSearchConfig();
		final IndexedType indexedType = facetSearchConfig.getIndexConfig().getIndexedTypes().values().iterator().next();
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInTwoSessionCatalogVersions()
			throws FacetSearchException, FacetConfigServiceException, IndexerException
	{
		// given
		final FacetSearchConfig facetSearchConfig = getFacetSearchConfig();
		final IndexedType indexedType = facetSearchConfig.getIndexConfig().getIndexedTypes().values().iterator().next();
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInOneSessionCatalogVersion()
			throws FacetSearchException, FacetConfigServiceException, IndexerException
	{
		// given
		final FacetSearchConfig facetSearchConfig = getFacetSearchConfig();
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInThird()
			throws FacetSearchException, FacetConfigServiceException, IndexerException
	{
		// given
		final FacetSearchConfig facetSearchConfig = getFacetSearchConfig();
	...
	@Test
	public void testIndexTwoCatalogVersionsSearchInTwoOthers()
			throws FacetSearchException, FacetConfigServiceException, IndexerException
	{
		// given
		final FacetSearchConfig facetSearchConfig = getFacetSearchConfig();
