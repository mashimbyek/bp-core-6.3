...
public class SolrMultithreadedAccessTest extends ServicelayerTest
{
	...
	public void testMultithreadedAccess()
	{
		...
		Assert.assertEquals("found worker errors", Collections.emptyMap(), threadsHolder.getErrors());
		for (final SolrOperationRunner solrRunner : threadsHolder.getRunners())
		{
			Assert.assertEquals("runner " + solrRunner + " had error turns", Collections.emptyList(), solrRunner.errorTurns);
		}
	}
	...
	private IndexedType mockIndexTypeForIndexName(final String indexName)
	{
		return IndexedTypes.createIndexedType(
				//
				null, false, Collections.emptyList(), null, null, null, Collections.emptySet(), null, indexName, null);
	}
