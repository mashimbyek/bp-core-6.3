...
public class DisMaxFreeTextQueryBuilderTest
{
	...
	public void testDisMaxFreeTextQueryBuilder() throws FacetSearchException
	{
		...
		final String expectedQuery = "{!multiMaxScore tie=0.0}"
				...
				// Phrase query
				+ "((name_text_de:\"test\\ test1t\\ test2t\"~10.0^200.0) OR (description_text_de:\"test\\ test1t\\ test2t\"~10.0^200.0))";
	...
	public void testFreeTextPhraseQuery() throws FacetSearchException
	{
		...
		// then
		final String expectedQuery = "{!multiMaxScore tie=0.0}((name_text_de:\"test\\ test1t\\ test2t\"~10.0^200.0) OR "
				+ "(description_text_de:\"test\\ test1t\\ test2t\"~10.0^200.0))";
		Assert.assertEquals(expectedQuery, query);
	}
	...
	public void testFreeTextMinTermLength() throws FacetSearchException
	{
		...
		// then
		final String expectedQuery = "{!multiMaxScore tie=0.0}((name_text_de:test1t*^25.0)) OR ((name_text_de:test2t*^25.0))";
