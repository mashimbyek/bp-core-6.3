...
{
	@Override
	public String convertTo(final CancelReason source, final Type<String> destinationType)
	{
		return source.toString();
	}

	@Override
	public CancelReason convertFrom(final String source, final Type<CancelReason> destinationType)
	{
