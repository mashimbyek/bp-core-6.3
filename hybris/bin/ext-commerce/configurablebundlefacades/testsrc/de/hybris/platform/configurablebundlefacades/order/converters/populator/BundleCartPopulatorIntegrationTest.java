...
import de.hybris.platform.configurablebundleservices.bundle.impl.DefaultBundleCartServiceNestedIntegrationTest;
...
public class BundleCartPopulatorIntegrationTest extends ServicelayerTest
{
    ...
    {
        addToCart(PRODUCT01, OPTIONAL_COMPONENT, DefaultBundleCommerceCartService.NEW_BUNDLE);
    ...
    public void productsFromDifferentPackages() throws CommerceCartModificationException
    {
        ...
        addToCart(PRODUCT01, SECOND_COMPONENT, DefaultBundleCommerceCartService.NEW_BUNDLE);
    ...
    protected OrderEntryData createOrderEntryData(String productCode) {
        return createOrderEntryData(productCode, DefaultBundleCommerceCartService.NO_BUNDLE, null, null);
    }
