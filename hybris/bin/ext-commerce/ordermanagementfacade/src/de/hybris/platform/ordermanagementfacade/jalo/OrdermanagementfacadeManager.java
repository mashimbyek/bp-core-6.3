 ...
 *
 */
package de.hybris.platform.ordermanagementfacade.jalo;
...
/**
 * This is the extension manager of the Ordermanagementfacade extension.
 */
public class OrdermanagementfacadeManager extends GeneratedOrdermanagementfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OrdermanagementfacadeManager.class.getName());
	 ...
	 */
	public static OrdermanagementfacadeManager getInstance()
	{
		return (OrdermanagementfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OrdermanagementfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OrdermanagementfacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OrdermanagementfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OrdermanagementfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OrdermanagementfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
