...
public class DefaultCommerceCartMergingStrategy extends AbstractCommerceCartStrategy implements CommerceCartMergingStrategy
{
	...
	protected void mergeModificationsToList(final List<CommerceCartModification> mergeModifications,
			final List<CommerceCartModification> modifications)
	{
		for (final CommerceCartModification mergeModification : mergeModifications)
		{
			mergeModificationToList(mergeModification, modifications);
		}
	}
