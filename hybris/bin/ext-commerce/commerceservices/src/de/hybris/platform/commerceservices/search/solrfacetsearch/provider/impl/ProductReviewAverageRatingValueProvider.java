 ...
 */
public class ProductReviewAverageRatingValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider,
		Serializable
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		final Double productRating = getProductRating(product, language);
	...
	protected Double getProductRating(final ProductModel product, final LanguageModel language)
	{
		double sum = 0d;
		int count = 0;
