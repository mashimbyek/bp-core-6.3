...
public class DefaultCommerceCartServiceRestorationTest extends ServicelayerTest
{
	...
	public void testCartRestore() throws CommerceCartRestorationException
	{
		...
		cart.setCurrency(commerceCommonI18NService.getAllCurrencies().stream().filter(currencyModel -> currencyModel.getIsocode().equalsIgnoreCase("USD"))
		...
		assertEquals("Old currency was set", commerceCommonI18NService.getCurrentCurrency(), cart.getCurrency());
