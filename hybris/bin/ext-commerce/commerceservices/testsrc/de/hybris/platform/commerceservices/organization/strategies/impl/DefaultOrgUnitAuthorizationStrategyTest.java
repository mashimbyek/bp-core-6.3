...
public class DefaultOrgUnitAuthorizationStrategyTest extends BaseCommerceBaseTest
{
	...
	public void shouldValidateViewPermissionNotAllowNonSales()
	{
		...
		defaultOrgUnitAuthorizationStrategy.validateViewPermission(userService.getUserForUID(UNASSIGNED_EMPLOYEE,
				EmployeeModel.class));
	}
	...
	{
		defaultOrgUnitAuthorizationStrategy.validateEditParentPermission(userService.getUserForUID(GLOBAL_ADMIN,
				EmployeeModel.class));
	}
	...
	public void shouldNotAllowEditParentForSalesManager()
	{
		...
		defaultOrgUnitAuthorizationStrategy.validateEditParentPermission(userService
				.getUserForUID(USA_MANAGER, EmployeeModel.class));
	}
	...
	public void shouldNotAllowEditParentForSalesEmployee()
	{
		...
		defaultOrgUnitAuthorizationStrategy.validateEditParentPermission(userService.getUserForUID(USA_EMPLOYEE,
				EmployeeModel.class));
	}
