...
public class RuleEngineRulePrepareInterceptorUnitTest
{
	...
	public void setUp() throws Exception
	{
		...
		when(ruleEngineService.getRuleModuleForRule(model)).thenReturn(kieModuleModel);
	...
	@Test
	public void testOnPrepareNewModuleVersionIsDefined() throws InterceptorException
	{
		when(kieModuleModel.getVersion()).thenReturn(valueOf(0));
		when(context.isNew(model)).thenReturn(true);
		model.setKieBase(null);
		model.setVersion(null);
