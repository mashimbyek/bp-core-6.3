...
public class DefaultPlatformRuleEngineServiceInitializeTest
{
	...
	private final Function<AbstractRulesModuleModel, RuleEngineActionResult> serviceInitializerPropagate = (module) -> service
			.initialize(module, null,true);

	private final Function<AbstractRulesModuleModel, RuleEngineActionResult> serviceInitializerDefault = (module) -> service
			.initialize(module);

	private final Function<AbstractRulesModuleModel, RuleEngineActionResult> serviceInitializerDontPropagate = (module) -> service
			.initialize(module, null,false);
	...
	@Test
	public void testInitializeAllRulesModulesSucceed() throws Exception
	{
		...
		verify(kieServices, times(4)).newReleaseId(anyString(), anyString(), anyString());
	}
