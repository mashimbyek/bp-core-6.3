...
public class DefaultEngineRuleDaoUnitTest
{
	...
	{
		engineRuleDao.getRuleByCode(null);
	}
	...
	public void testGetRuleByCodeNotFound()
	{
		...
		engineRuleDao.getRuleByCode(RULE_CODE);
	}
	...
	@Test
	public void testGetRulesForVersion()
	{
		final SearchResult<AbstractRuleEngineRuleModel> searchResult = mock(SearchResult.class);
		...
		List<AbstractRuleEngineRuleModel> rulesForVersion = engineRuleDao.getRulesForVersion(rulesModuleModel, 0);
		...
		rulesForVersion = engineRuleDao.getRulesForVersion(rulesModuleModel, 1);
		...
		rulesForVersion = engineRuleDao.getRulesForVersion(rulesModuleModel, 2);
		...
		rulesForVersion = engineRuleDao.getRulesForVersion(rulesModuleModel, 3);
	...
	public void testGetRulesForVersionNotFound()
	{
		...
		final List<AbstractRuleEngineRuleModel> rulesForVersion = engineRuleDao.getRulesForVersion(rulesModuleModel, 0l);
	...
	public void testGetRuleVersion()
	{
		...
		final Long nextRuleVersion = engineRuleDao.getRuleVersion(rulesModuleModel, RULE_CODE);
		assertThat(nextRuleVersion).isNotNull().isEqualTo(version);
	}
	...
	{
		engineRuleDao.getRuleVersion(rulesModuleModel, null);
	}
	...
	public void testGetByRuleCodeAndMaxVersion()
	{
		...
		final AbstractRuleEngineRuleModel ruleModel = engineRuleDao.getRuleByCodeAndMaxVersion(RULE_CODE, 1l);
		assertThat(ruleModel).isNotNull().isInstanceOf(TestAbstractRuleEngineRuleModel.class);
		assertThat(ruleModel.getCode()).isEqualTo(RULE_CODE);
		assertThat(ruleModel.getVersion()).isEqualTo(0l);
	}
	...
	public void testGetRuleVersionByCode()
	{
		...
		final Long nextRuleVersion = engineRuleDao.getRuleVersion(RULE_CODE);
		assertThat(nextRuleVersion).isNotNull().isEqualTo(version);
	}
	...
	{
		engineRuleDao.getRuleVersion(null);
	}
