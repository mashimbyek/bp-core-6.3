...
@UnitTest
public class B2BPermissionPopulatorTest
{
	...
	private final B2BPermissionPopulator b2bPermissionDataPopulator = new B2BPermissionPopulator();
	...
	@Test
	public void testPopulateBudgetExceededPermissionUnitNull()
	{
		final B2BPermissionModel source = prepareBudgetExceededPermissionUnitNull();
		final B2BPermissionData target = new B2BPermissionData();

		b2bPermissionDataPopulator.populate(source, target);

		Assert.assertNull("B2BUnitData was not null", target.getUnit());
	}
	...
	public void testPopulateSourceNull()
	{
		...
		b2bPermissionDataPopulator.populate(null, new B2BPermissionData());
	}
	...
	public void testPopulateTargetNull()
	{
		...
		b2bPermissionDataPopulator.populate(new B2BPermissionModel(), null);
	}
	...
	protected B2BPermissionModel prepareBudgetExceededPermissionUnitNull()
	{
		final B2BPermissionModel model = new B2BBudgetExceededPermissionModel();
		model.setCode(TEST_BUDGET_EXCEEDED_PERMISSION);
		model.setUnit(null);
