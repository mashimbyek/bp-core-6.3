 ...
 */
package de.hybris.platform.warehousingfacade.jalo;
...
/**
 * This is the extension manager of the Warehousingfacade extension.
 */
public class WarehousingfacadeManager extends GeneratedWarehousingfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WarehousingfacadeManager.class.getName());
	 ...
	 */
	public static WarehousingfacadeManager getInstance()
	{
		return (WarehousingfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				WarehousingfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WarehousingfacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WarehousingfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of WarehousingfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of WarehousingfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
