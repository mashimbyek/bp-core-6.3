...
public class QualifyingCategoryPotentialPromotionMessageActionSupplementStrategyUnitTest
{
	...
	Map<String, Object> srcParameters3 = new HashMap<>();
	...
	public void setUp()
	{
		...
		srcParameters3.put(
				...
				UUID);
		srcParameters3.put(QualifyingCategoryPotentialPromotionMessageActionSupplementStrategy.CATEGORY_PARAMETER, CATEGORY2_CODE);
		srcParameters3.put(QualifyingCategoryPotentialPromotionMessageActionSupplementStrategy.CATEGORY_PARAMETER_UUID, UUID);
	}
	...
	public void testPostProcessActionForQualifiedCategoryQuantity()
	{
		...
		strategy.postProcessAction(displayMessageRAO, context, srcParameters3);
