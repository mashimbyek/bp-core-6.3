...
public class QualifyingProductPotentialPromotionMessageActionSupplementStrategyUnitTest
{
	...
	Map<String, Object> srcParameters2 = new HashMap<>();
	...
	public void setUp()
	{
		...
		srcParameters2.put(QualifyingProductPotentialPromotionMessageActionSupplementStrategy.PRODUCTS_QUANTITY_PARAMETER,
				PRODUCT_QUANTITY_PARAM);
		srcParameters2.put(QualifyingProductPotentialPromotionMessageActionSupplementStrategy.PRODUCTS_QUANTITY_PARAMETER_UUID,
				UUID);
		srcParameters2.put(QualifyingProductPotentialPromotionMessageActionSupplementStrategy.PRODUCT_PARAMETER, PRODUCT1_CODE);
		srcParameters2.put(QualifyingProductPotentialPromotionMessageActionSupplementStrategy.PRODUCT_PARAMETER_UUID, UUID);
	}
	...
	public void testPostProcessActionForQualifiedProductQuantity()
	{
		...
		strategy.postProcessAction(displayMessageRAO, context, srcParameters2);
