...
{
	private static final Logger LOG = LoggerFactory.getLogger(PromotionGroupTest.class);
	private Cart cart;
	private Product testProduct1;
	private List<PromotionGroup> promotionGroups;
	private PromotionsManager proManager;
	...
	public void testProductSteppedMultiBuyPromotion()
	{
		...
		LOG.info("{}", Double.valueOf(totalPrice));
		proManager.updatePromotions(jaloSession.getSessionContext(), promotionGroups, cart, false, AutoApplyMode.APPLY_ALL,
				AutoApplyMode.APPLY_ALL, new java.util.Date());
