...
public class ProductPromotionsTest extends AbstractPromotionServiceTest
{
	...
	{
		//also see SUP-3575
		final PromotionGroupModel promotionGroup1 = defaultPromotionsService.getPromotionGroup("prGroup1");
		List<ProductPromotionModel> productPromotions = defaultPromotionsService
				.getProductPromotions(Collections.singleton(promotionGroup1), product);
		...
		productPromotions = defaultPromotionsService.getProductPromotions(Arrays.asList(promotionGroup1, promotionGroup2), product);
		testPromotionCodes(productPromotions, Arrays.asList("FixedPriceGr1", "FixedPriceGr2"));

		final PromotionGroupModel promotionGroup4 = defaultPromotionsService.getPromotionGroup("prGroup4");
		productPromotions = defaultPromotionsService
				.getProductPromotions(Arrays.asList(promotionGroup1, promotionGroup2, promotionGroup4), product);
		...
		final PromotionGroupModel independentGroup = defaultPromotionsService.getPromotionGroup("independentGroup");
		productPromotions = defaultPromotionsService.getProductPromotions(
