...
public class ProductBundlePromotionTest extends AbstractPromotionTest
{
	...
	public void testProductBundlePromotion() throws CalculationException
	{
		...
		final PromotionGroupModel promotionGroup = defaultPromotionsService.getPromotionGroup("prGroup2");
		...
		assertEquals("cart total after updatePromotions(ProductBundlePromotion)", 1629.5d, cart.getTotalPrice().doubleValue(),
				0.01);
	}
}
