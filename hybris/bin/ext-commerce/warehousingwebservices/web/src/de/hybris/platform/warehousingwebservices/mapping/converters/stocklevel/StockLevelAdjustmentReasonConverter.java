...
{
	@Override
	public StockLevelAdjustmentReason convertFrom(final String source, final Type<StockLevelAdjustmentReason> destinationType)
	{
		return StockLevelAdjustmentReason.valueOf(source);
	}

	@Override
	public String convertTo(final StockLevelAdjustmentReason source, final Type<String> destinationType)
	{
