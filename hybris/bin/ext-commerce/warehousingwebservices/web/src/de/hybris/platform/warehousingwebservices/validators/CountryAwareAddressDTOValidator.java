...
/**
 * Implementation of {@link org.springframework.validation.Validator} that validate instances of {@link de.hybris.platform.commercewebservicescommons.dto.user.AddressWsDTO}.
 *
...
public class CountryAwareAddressDTOValidator implements Validator
{
	...
	public void validate(final Object target, final Errors errors)
	{
		...
		Validator addressValidator = getCountrySpecificAddressValidators().get(address.getCountry().getIsocode());

		if (addressValidator == null)
		{
			addressValidator = getCommonAddressValidator();
		}
	...
	protected Map<String, Validator> getCountrySpecificAddressValidators()
	{
