...
/**
 * This is the extension manager of the Customerinterestsfacades extension.
 */
public class CustomerinterestsfacadesManager extends GeneratedCustomerinterestsfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CustomerinterestsfacadesManager.class);
	 ...
	 */
	public static CustomerinterestsfacadesManager getInstance()
	{
		return (CustomerinterestsfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustomerinterestsfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerinterestsfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of CustomerinterestsfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CustomerinterestsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CustomerinterestsfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
