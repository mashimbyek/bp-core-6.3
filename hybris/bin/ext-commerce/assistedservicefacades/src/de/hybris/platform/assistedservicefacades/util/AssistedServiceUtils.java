...
public final class AssistedServiceUtils
{
	...
	{
		final List<Long> timeMillis = Arrays.asList(
		...
		final List<TimeSince> timeUnits = Arrays.asList(
				TimeSince.YEARS, TimeSince.YEAR,
				TimeSince.MONTHS, TimeSince.MONTH,
				TimeSince.DAYS, TimeSince.DAY,
				TimeSince.HOURS, TimeSince.HOUR,
				TimeSince.MINUTES, TimeSince.MINUTE,
