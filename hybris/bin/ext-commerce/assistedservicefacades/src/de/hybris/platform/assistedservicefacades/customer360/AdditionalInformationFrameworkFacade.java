...
public interface AdditionalInformationFrameworkFacade
{
	...
	/**
	 * @deprecated since 6.3 use {@link #getFragment(String, String, Map)} instead.
	 *
	 *             Retrieves a fragment based on section id and fragment id
	 *
	 * @param sectionId
	 ...
	 */
	@Deprecated
	Fragment getFragment(final String sectionId, String fragmentId);
