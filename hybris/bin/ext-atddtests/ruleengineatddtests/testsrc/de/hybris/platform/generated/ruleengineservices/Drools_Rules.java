 ...
 */
package de.hybris.platform.generated.ruleengineservices;
...
@IntegrationTest
public class Drools_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setOutputDir(new File(Config.getParameter("atddengine.report-path"), "ruleengineservices"));
			robotSettings.setLogName("Drools_Rules-log");
			robotSettings.setOutputName("Drools_Rules-output");
			robotSettings.setReportName("Drools_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/ruleengineatddtests/genresources/robottests/Drools_Rules.txt"));
		}
	...
	@Test
	public void Test_Log_Some_Fatal_Text()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Log_Some_Fatal_Text";
