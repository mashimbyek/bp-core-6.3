...
public class EntitlementFacadePopulator_Test extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/emsclientatddtests/genresources/robottests/EntitlementFacadePopulator_Test.txt"));
		}
	...
	@Test
	public void Test_GrantUnknownEntitlement_AndCheckUserGrants()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_GrantUnknownEntitlement_AndCheckUserGrants";
	...
	@Test
	public void Test_GrantUnknownMeteredEntitlement_AndCheckUserGrants()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_GrantUnknownMeteredEntitlement_AndCheckUserGrants";
