...
public class Product_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Product_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Fixed_Price_For_Category_Promotion_TestCase_1()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Fixed_Price_For_Category_Promotion_TestCase_1";
	...
	@Test
	public void Test_Apply_Fixed_Price_For_Category_Promotion_TestCase_2()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Fixed_Price_For_Category_Promotion_TestCase_2";
	...
	@Test
	public void Test_No_Promotion_Applied_Only_Excluded_Product()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_No_Promotion_Applied_Only_Excluded_Product";
	...
	@Test
	public void Test_Apply_Percentage_Threshold_Promotion_Without_Excluded_Products()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Percentage_Threshold_Promotion_Without_Excluded_Products";
	...
	@Test
	public void Test_Apply_Percentage_Threshold_Promotion_With_Excluded_Products_Undo()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Percentage_Threshold_Promotion_With_Excluded_Products_Undo";
	...
	@Test
	public void Test_Product_Price_Threshold_Fixed_Discount()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Price_Threshold_Fixed_Discount";
	...
	@Test
	public void Test_Order_Threshold_Fixed_Price_Products()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Order_Threshold_Fixed_Price_Products";
	...
	@Test
	public void Test_Order_Threshold_Percentage_Discount_Products()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Order_Threshold_Percentage_Discount_Products";
	...
	@Test
	public void Test_Product_Bundle_Fixed_Price()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Bundle_Fixed_Price";
	...
	@Test
	public void Test_Product_Buy_X_Get_Y_Free()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Buy_X_Get_Y_Free";
	...
	@Test
	public void Test_Product_Buy_X_Get_Y_Free_Twice()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Buy_X_Get_Y_Free_Twice";
	...
	@Test
	public void Test_Product_Fixed_Discount()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Fixed_Discount";
	...
	@Test
	public void Test_Product_Multibuy_Fixed_Price()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Multibuy_Fixed_Price";
	...
	@Test
	public void Test_Product_Perfect_Partner_Percentage_Discount()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Product_Perfect_Partner_Percentage_Discount";
