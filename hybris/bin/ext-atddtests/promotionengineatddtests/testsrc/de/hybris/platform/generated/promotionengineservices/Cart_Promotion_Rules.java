...
@IntegrationTest
public class Cart_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Cart_Promotion_Rules-log");
			robotSettings.setOutputName("Cart_Promotion_Rules-output");
			robotSettings.setReportName("Cart_Promotion_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Cart_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Promotion_To_Cart_With_Total_Less_Than_250()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Promotion_To_Cart_With_Total_Less_Than_250";
	...
	public void Test_Apply_Promotion_To_Cart_Total_Bigger_250_Three_Same_Products()
	{
		...
		final String robotTestName = "Test_Apply_Promotion_To_Cart_Total_Bigger_250_Three_Same_Products";
	...
	public void Test_Order_Threshold_Free_Coupon_Promotion_To_Cart_With_Total_GreaterEqual_300()
	{
		...
		final String robotTestName = "Test_Order_Threshold_Free_Coupon_Promotion_To_Cart_With_Total_GreaterEqual_300";
	...
	public void Test_Percentage_Discount_When_Product_NOT_In_Cart()
	{
		...
		final String robotTestName = "Test_Percentage_Discount_When_Product_NOT_In_Cart";
	...
	public void Test_Percentage_Discount_When_Product_From_Categories_NOT_in_cart()
	{
		...
		final String robotTestName = "Test_Percentage_Discount_When_Product_From_Categories_NOT_in_cart";
	...
	public void Test_Potential_Promotion_Message_Triggered_With_Potential_Product_Bundle_Fixed_Price()
	{
		...
		final String robotTestName = "Test_Potential_Promotion_Message_Triggered_With_Potential_Product_Bundle_Fixed_Price";
