...
public class Promotions_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Promotions_Rules.txt"));
		}
	...
	@Test
	public void Test_Order_Threshold_Percentage_Discount_Cart()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Order_Threshold_Percentage_Discount_Cart";
