...
@IntegrationTest
public class Customer_Promotion_Rules extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Customer_Promotion_Rules-log");
			robotSettings.setOutputName("Customer_Promotion_Rules-output");
			robotSettings.setReportName("Customer_Promotion_Rules-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/promotionengineatddtests/genresources/robottests/Customer_Promotion_Rules.txt"));
		}
	...
	@Test
	public void Test_Apply_Percentage_Discount_When_Customer_Is_Not_Part_Of_Specific_Customer_Group()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Apply_Percentage_Discount_When_Customer_Is_Not_Part_Of_Specific_Customer_Group";
