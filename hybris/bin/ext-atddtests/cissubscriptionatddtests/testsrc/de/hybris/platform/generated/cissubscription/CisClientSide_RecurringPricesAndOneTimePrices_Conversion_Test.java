	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/cissubscriptionatddtests/genresources/robottests/CisClientSide_RecurringPricesAndOneTimePrices_Conversion_Test.txt"));
		}
