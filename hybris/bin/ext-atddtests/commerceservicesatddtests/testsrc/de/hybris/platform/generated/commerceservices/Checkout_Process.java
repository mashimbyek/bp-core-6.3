...
@IntegrationTest
public class Checkout_Process extends ServicelayerTest implements RobotTestContext
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotSettings.setLogName("Checkout_Process-log");
			robotSettings.setOutputName("Checkout_Process-output");
			robotSettings.setReportName("Checkout_Process-report");
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/opt/bambooagent/xml-data/build-dir/CI-CI630-PREP/maintenance/bin/ext-atddtests/commerceservicesatddtests/genresources/robottests/Checkout_Process.txt"));
		}
	...
	@Test
	public void Test_Checkout_CartAssignment()
	{
		modelService.detachAll();
		
		final String robotTestName = "Test_Checkout_CartAssignment";
