...
import de.hybris.platform.storefront.constants.B2ctelcocheckoutaddonConstants;



/**
 * This is the extension manager of the B2ctelcocheckoutaddon extension.
 */
public class B2ctelcocheckoutaddonManager extends GeneratedB2ctelcocheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcocheckoutaddonManager.class.getName());
	 ...
	 */
	public B2ctelcocheckoutaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcocheckoutaddonManager called.");
		}
	}
	 ...
	 */
	public static B2ctelcocheckoutaddonManager getInstance()
	{
		return (B2ctelcocheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcocheckoutaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcocheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcocheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
