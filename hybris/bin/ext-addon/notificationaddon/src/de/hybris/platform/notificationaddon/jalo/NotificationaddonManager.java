...
/**
 * This is the extension manager of the Notificationaddon extension.
 */
public class NotificationaddonManager extends GeneratedNotificationaddonManager
{
	 ...
	 */
	public static NotificationaddonManager getInstance()
	{
		return (NotificationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NotificationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NotificationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NotificationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NotificationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NotificationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
