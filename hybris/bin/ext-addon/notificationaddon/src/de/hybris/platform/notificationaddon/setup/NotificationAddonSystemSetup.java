 ...
 */
package de.hybris.platform.notificationaddon.setup;
...
@SystemSetup(extension = NotificationaddonConstants.EXTENSIONNAME)
public class NotificationAddonSystemSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(NotificationaddonConstants.class);
