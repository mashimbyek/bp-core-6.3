 ...
 */
package de.hybris.platform.chineselogisticaddon.setup;
 ...
 */
@SystemSetup(extension = ChineselogisticaddonConstants.EXTENSIONNAME)
public class ChineseLogisticaddonSystemSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChineseLogisticaddonSystemSetup.class);
