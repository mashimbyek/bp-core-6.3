...
<spring:url htmlEscape="false" var="accountSummaryUnitDetailsUrl" value="/my-company/organization-management/accountsummary-unit/details"/>
		...
		<div class="filterByValue col-md-5">
			<div id="rangeCriteria" class="rangeCriteria criterias row" style="display: none;"
                ...
                <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <div id="startRangeCriteria" class="date-input">
                        <input id="startRange" class="form-control filterCriteria" name="startRange" type="text" value="${criteriaData.startRange}"/>
                        <i class=""></i>
                    </div>
                </div>
                <div class="col-sm-6 col-md-4 form-group">
                    ...
                    <div id="endRangeCriteria" class="date-input">
                        <input id="endRange" class="form-control filterCriteria" name="endRange" type="text" value="${criteriaData.endRange}"/>
                        <i class=""></i>
                    </div>
                </div>
			</div>
                ...
                <div class="row">
                    ...
                    <select id="documentTypeCode" name="documentTypeCode" class="form-control filterCriteria">
                        ...
                        <c:forEach items="${documentTypeList}" var="documentType">
                            <option id="${documentType.code}" value="${documentType.code}" ${documentType.code eq criteriaData.documentTypeCode ? 'selected="selected"' : ''}>${documentType.name}</option>
                        </c:forEach>
                    </select>
			    </div>
			</div>
			<div id="singleValueCriteria" class="singleValueCriteria criterias col-md-7 form-group" style="display: none;"
                ...
                <div class="row">
                    ...
                    <div id="singleValue">
                        <input id="filterByValue" class="form-control filterCriteria" name="filterByValue" type="text" value="${criteriaData.filterByValue}"/>
                    </div>
                </div>
			</div>
		</div>
...
<c:choose>
	<c:when test="${empty searchPageData.results}">
		<div class="account-section-content	account-section-content-small col-md-6 col-md-push-3 content-empty">
