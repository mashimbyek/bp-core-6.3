                    ...
                    <div class="account-cards card-select">
                        <div class="row">
                            <c:forEach items="${searchPageData.results}" var="b2bBudget">
                                <div id="card-${ycommerce:normalizedCode(b2bBudget.code)}" class="col-xs-12 col-sm-6 col-md-4 card <c:if test='${b2bBudget.selected}'>selected</c:if>">
                                    <ul class="card-${ycommerce:normalizedCode(b2bBudget.code)} pull-left">
                                        <spring:url
                                    ...
                                    <span id="span-${ycommerce:normalizedCode(b2bBudget.code)}" class="account-cards-actions pull-left">
