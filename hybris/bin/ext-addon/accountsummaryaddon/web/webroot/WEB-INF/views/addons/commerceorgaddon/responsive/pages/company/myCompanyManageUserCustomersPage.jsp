                        ...
                        <div class="account-cards card-select">
                            <div class="row">
                                <c:forEach items="${searchPageData.results}" var="user">
                                    ...
                                    <div id="row-${ycommerce:normalizedCode(user.normalizedUid)}" class="col-xs-12 col-sm-6 col-md-4 card <c:if test='${user.selected}'>selected</c:if>">
                                        <ul class="pull-left">
                                            <li>
                                        ...
                                        <ycommerce:testId code="${action}_actions_label">
                                            ...
                                            <c:choose>
                                                <c:when test="${user.active}">
                                                    <span id="selection-${ycommerce:normalizedCode(user.normalizedUid)}" class="account-cards-actions pull-left">
                                                        <c:choose>
