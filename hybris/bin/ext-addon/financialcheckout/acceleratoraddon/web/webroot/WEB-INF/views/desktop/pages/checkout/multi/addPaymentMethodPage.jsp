	...
	<div class="span-14 append-1">
		<div id="checkoutContentPanel" class="clearfix">
			...
			<form:form method="post" commandName="paymentDetailsForm" class="create_update_payment_form">
                ...
                <%--The has only done with visually hidden for the reasons for:--%>
                <%--We might need this function in the future once the form persistance and data capture has been implemented, and then we could remove the mock delivery data.--%>
                <%--There is/maybe some javascript dependency on this element being in the page (relating to showing and hiding the billing address info)--%>
				<div style="display:none">
					<c:if test="${cartData.deliveryItemsQuantity > 0}">
						<form:checkbox id="differentAddress" path="newBillingAddress" tabindex="9" checked="true"/>
                ...
                <div id="form_button_panel" class="form-actions">
                    <ycommerce:testId code="multicheckout_cancel_button">
                        <a class="button" href="${previousStep}"><spring:theme code="checkout.multi.quoteForm.back" text="Back"/></a>
                    </ycommerce:testId>
