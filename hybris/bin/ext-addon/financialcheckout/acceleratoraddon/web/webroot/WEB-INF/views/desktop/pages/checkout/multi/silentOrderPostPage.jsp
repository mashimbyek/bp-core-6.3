...
<template:page pageTitle="${pageTitle}">
	...
	<c:if test="${not empty paymentFormUrl}">
		<div class="span-15 append-1">
			<div id="checkoutContentPanel" class="clearfix checkoutContent">
				<ycommerce:testId code="paymentDetailsForm">
				<div class="greyBox greyBoxPadding">
				<form:form id="silentOrderPostForm" name="silentOrderPostForm" commandName="sopPaymentDetailsForm" class="create_update_payment_form" action="${paymentFormUrl}" method="POST">
					...
					<c:if test="${not empty paymentInfos}">
						<button type="button" class="submitRemoveProduct button clear clear view-saved-payments" id="viewSavedPayments">
				...
				<c:url value="${nextStepUrl}" var="nextStep"/>
					...
					<div class="form-actions">
						<a class="button negative" href="${previousStep}"><spring:theme code="checkout.multi.quoteForm.back" text="Back"/></a>
