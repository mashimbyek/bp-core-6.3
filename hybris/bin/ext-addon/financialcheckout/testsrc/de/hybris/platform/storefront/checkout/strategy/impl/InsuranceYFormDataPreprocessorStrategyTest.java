...
public class InsuranceYFormDataPreprocessorStrategyTest
{
	...
	public void shouldUpdateXmlContent() throws YFormProcessorException
	{
		...
		final String expectedXmlContent = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><form><personal-details><first-name/><last-name/><age>"
				+ age50 + "</age><phone/>" + "<email/><address-line1/><address-line2/><address-city/><address-postcode/>"
				+ "<address-country/></personal-details><number-of-travellers>" + noOfTravellers.toString()
				+ "</number-of-travellers>" + "<traveller-1><first-name-1/><last-name-1/><age-1>" + age45 + "</age-1>"
