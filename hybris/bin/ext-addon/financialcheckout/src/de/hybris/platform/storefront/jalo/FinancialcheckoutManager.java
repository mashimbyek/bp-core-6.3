...
/**
 * This is the extension manager of the Financialcheckout extension.
 */
public class FinancialcheckoutManager extends GeneratedFinancialcheckoutManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FinancialcheckoutManager.class.getName());
	 ...
	 */
	public static FinancialcheckoutManager getInstance()
	{
		return (FinancialcheckoutManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(InsurancecheckoutConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FinancialcheckoutManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of InsurancecheckoutManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of InsurancecheckoutManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of InsurancecheckoutManager called, current tenant: " + getTenant().getTenantID());
		}
	}
