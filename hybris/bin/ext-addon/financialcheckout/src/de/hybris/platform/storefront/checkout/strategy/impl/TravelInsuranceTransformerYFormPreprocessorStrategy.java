		...
		if (quoteModel.getProperties().containsKey(InsurancecheckoutConstants.TRIP_DETAILS_NO_OF_TRAVELLERS))
		{
			...
			if (quoteModel.getProperties().containsKey(InsurancecheckoutConstants.TRIP_DETAILS_TRAVELLER_AGES_FOR_PRE_FORM_POPULATE)
					&& quoteModel.getProperties()
							.get(InsurancecheckoutConstants.TRIP_DETAILS_TRAVELLER_AGES_FOR_PRE_FORM_POPULATE) instanceof List)
			{
				final List<String> ages = (List<String>) quoteModel.getProperties()
						.get(InsurancecheckoutConstants.TRIP_DETAILS_TRAVELLER_AGES_FOR_PRE_FORM_POPULATE);
