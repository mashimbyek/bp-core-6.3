 ...
 */
package de.hybris.platform.integration.cis.tax.jalo;
...
/**
 * This is the extension manager of the Cistaxhmc extension.
 */
public class CistaxhmcManager extends GeneratedCistaxhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CistaxhmcManager.class);
	 ...
	 */
	public static CistaxhmcManager getInstance()
	{
		return (CistaxhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CistaxhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CistaxhmcManager() // NOPMD 
	{
		LOG.debug("constructor of CistaxhmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CistaxhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CistaxhmcManager called, current tenant: {}", getTenant().getTenantID());
	}
