...
public class DefaultCistaxhmcService implements CistaxhmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCistaxhmcService.class);
	...
	{
		return DefaultCistaxhmcService.class.getResourceAsStream("/cistaxhmc/sap-hybris-platform.png");
	}
