 ...
 */
package de.hybris.platform.addonsupport.controllers.page;
...
public class AbstractAddOnPageController extends AbstractAddOnController
{
	 ...
	 *             {@link de.hybris.platform.addonsupport.controllers.page.AbstractAddOnPageController#LOGGER} instead.
	 */
	@Deprecated
	protected static final Logger LOG = Logger.getLogger(AbstractAddOnPageController.class);
	private static final Logger LOGGER = Logger.getLogger(AbstractAddOnPageController.class);
	...
	protected String checkRequestUrl(final HttpServletRequest request, final HttpServletResponse response,
			final String resolvedUrlPath, final String responseStatusAttributeName) throws UnsupportedEncodingException
	{
		try
		{
