...
public class DefaultAddOnCMSComponentRenderer<C extends AbstractCMSComponentModel> implements CMSComponentRenderer<C>
{
	 ...
	 *             {@link de.hybris.platform.addonsupport.renderer.impl.DefaultAddOnCMSComponentRenderer#LOGGER} instead.
	 */
	@Deprecated
	protected static final Logger LOG = Logger.getLogger(DefaultAddOnCMSComponentRenderer.class);
