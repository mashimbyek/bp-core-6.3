 ...
 *  
 */
package de.hybris.eventtracking.ws.hmc;
...
/**
 * Provides necessary meta information about the eventtrackingwsaddon hmc extension.
 * 
 * 
 * @version ExtGen v5.2.0.0
 */
public class EventtrackingwsaddonHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(EventtrackingwsaddonHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.storefront.eventtracking.ws.hmc.locales";
