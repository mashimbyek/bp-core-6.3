...
<form:form action="${request.contextPath}/my-account/order/${order.code}/cancel/cancelconfirmation"
                ...
                <li class="item__list--item">
                            ...
                            <div class="item__configurations">
                                <c:forEach var="config" items="${entry.configurationInfos}">
                                    ...
                                    <div class="item__configuration-entry row" style="${style}">
                                        <div class="item__configuration-name col-md-4">${config.configurationLabel}:</div>
                                        <div class="item__configuration-value col-md-8">${config.configurationValue}</div>
                                    </div>
                                </c:forEach>
                            </div>
                    ...
                    <div class="item__delivery">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                        <span><spring:theme
                                                code="text.account.cancel.pickup.from"/><span></span>${entry.deliveryPointOfService.name}</span>
                            </c:otherwise>
                        </c:choose>
                    </div>
                        <%-- price --%>
                ...
                <c:forEach items="${entry.entries}" var="nentry" varStatus="nloop">
                    <c:if test="${nentry.cancellableQty > 0}">
                        <li class="item__list--item">
                            ...
                            <div class="item__info">
                                <ycommerce:testId code="cancel_product_name">
                                    <span class="item__name">${nentry.product.name}</span>
                                </ycommerce:testId>

                                <div class="item__code">${nentry.product.code}</div>
