...
<ul class="item__list cart__list return__list">
    ...
    <c:forEach items="${returnRequest.entries}" var="entry" varStatus="loop">
        <li class="item__list--item">
            ...
            <div class="item__info">
                <ycommerce:testId code="return_product_name">
                    <span class="item__name">${entry.orderEntry.product.name}</span>
                </ycommerce:testId>

                <div class="item__code">${entry.orderEntry.product.code}</div>
