...
public class AcceleratorwebservicesaddonManager extends GeneratedAcceleratorwebservicesaddonManager
{
	 ...
	 */
	public AcceleratorwebservicesaddonManager() // NOPMD 
	{
	...
	{
		return (AcceleratorwebservicesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AcceleratorwebservicesaddonConstants.EXTENSIONNAME);
	}
