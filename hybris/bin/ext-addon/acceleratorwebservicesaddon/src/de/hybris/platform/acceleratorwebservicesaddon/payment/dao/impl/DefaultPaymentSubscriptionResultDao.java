...
{
	private static final String FIND_SUBSCRIPTION_RESULT_BY_CART = "SELECT {" + PaymentSubscriptionResultModel.PK + "} FROM {" //NOSONAR
			+ PaymentSubscriptionResultModel._TYPECODE + "} WHERE {" + PaymentSubscriptionResultModel.CARTID + "} = ?cartId"; //NOSONAR
	private static final String FIND_SUBSCRIPTION_RESULT_BY_CART_CODE_AND_GUID = "SELECT {" + PaymentSubscriptionResultModel.PK
	...
	private static final String FIND_OLD_SUBSCRIPTION_RESULT = "SELECT {" + PaymentSubscriptionResultModel.PK + "} FROM {"
