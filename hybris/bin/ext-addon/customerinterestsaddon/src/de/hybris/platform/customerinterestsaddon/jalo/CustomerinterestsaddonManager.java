...
/**
 * This is the extension manager of the Customerinterestsaddon extension.
 */
public class CustomerinterestsaddonManager extends GeneratedCustomerinterestsaddonManager
{
	 ...
	 */
	public static CustomerinterestsaddonManager getInstance()
	{
		return (CustomerinterestsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomerinterestsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomerinterestsaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomerinterestsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomerinterestsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomerinterestsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
