...
public class PromotionEngineSamplesAddonManager extends GeneratedPromotionEngineSamplesAddonManager
{
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of PromotionenginesamplesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of PromotionenginesamplesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
