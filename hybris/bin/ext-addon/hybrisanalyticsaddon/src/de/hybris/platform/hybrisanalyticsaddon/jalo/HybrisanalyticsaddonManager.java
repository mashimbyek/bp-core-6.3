...
public class HybrisanalyticsaddonManager extends GeneratedHybrisanalyticsaddonManager
{
	...
	{
		return (HybrisanalyticsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HybrisanalyticsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HybrisanalyticsaddonManager() // NOPMD 
	{
