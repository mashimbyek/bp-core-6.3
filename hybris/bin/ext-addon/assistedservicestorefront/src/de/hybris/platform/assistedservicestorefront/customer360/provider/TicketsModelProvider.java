...
{
	protected final static int MAX_AMOUNT = 10;
	...
	public List<GeneralActivityData> getModel(final Map<String, String> parameters)
	{
		...
		return ticketModel.stream().sorted(Comparator.comparing(CsTicketModel::getModifiedtime).reversed()).limit(getEventNumberLimit())
