            ...
            <tbody>
                <c:forEach items="${fragmentData}" var="activityData">
                    <tr>
                        ...
                        <td data-th="Headline" class="break-word" title="<spring:theme code='${activityData.description}' htmlEscape='true'/>"><spring:theme code="${activityData.description}" htmlEscape="true"/></td>
