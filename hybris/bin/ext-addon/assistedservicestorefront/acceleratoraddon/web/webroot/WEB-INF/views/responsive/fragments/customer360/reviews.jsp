        ...
        <table id="asm-customer360-reviews-table" class="table techne-table">
            ...
            <tbody>
                <c:forEach items="${fragmentData}" var="reviewData">
                    ...
                    <tr>
                        <td data-th="Item"><a title="${reviewData.productName}" href="${productUrl}" class="responsive-table-link text-nowrap"><c:out value="${reviewData.productName}, SKU: ${reviewData.SKUNumber}" /></a></td>
                        <td data-th="Date / Status" class="break-word"><span><fmt:formatDate value="${reviewData.created}" pattern="dd-MM-YYYY" />&nbsp;</span>/&nbsp;<spring:theme code="${reviewData.reviewStatus}" /> </td>
                        ...
                        <td data-th="Review" title="<spring:theme code='${reviewData.reviewText}' htmlEscape='true'/>"><spring:theme code="${reviewData.reviewText}" htmlEscape="true"/></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
