...
<c:choose>
	...
	<c:otherwise>
	   	<div class="asm__customer360-headline">
	        <spring:message code="text.customer360.overview.customer.savedCart"  text="Latest Saved Cart"/>&nbsp;<a href="${savedCartUrl}/${cart.code}">${cart.code}</a>
	                    ...
	                    <div class="asm__customer360-overview-saved">
	                        ...
	                        <div class="asm__customer360-overview-saved-text-wrap">
                                <div class="asm__customer360-overview-product-name">
                                    <a href="${productUrl}" class="responsive-table-link text-nowrap" title="${entry.product.name}">
                                        <div class="hide_overflow">${entry.product.name}</div>
                                    </a>
                                </div>
                                <div class="asm__customer360-overview-product-sku">${entry.product.code}</div>
