...
import de.hybris.platform.assistedservicestorefront.customer360.provider.HeadingDataProvider;
...
public class HeadingDataProviderTest
{
    ...
    @InjectMocks
    private HeadingDataProvider dataProvider = new HeadingDataProvider();
    ...
    public void testDataProviding()
    {
        ...
        Mockito.when(ticketService.getTicketsForCustomerOrderByModifiedTime(Mockito.anyObject(), Mockito.anyObject(),Mockito.anyObject()))
            .thenReturn(pageData);
