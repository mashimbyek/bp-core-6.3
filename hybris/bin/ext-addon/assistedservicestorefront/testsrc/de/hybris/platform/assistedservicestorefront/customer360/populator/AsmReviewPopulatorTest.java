...
import de.hybris.platform.assistedservicestorefront.customer360.populators.ReviewDataPopulator;
...
{
    @InjectMocks
    private ReviewDataPopulator populator = new ReviewDataPopulator();
