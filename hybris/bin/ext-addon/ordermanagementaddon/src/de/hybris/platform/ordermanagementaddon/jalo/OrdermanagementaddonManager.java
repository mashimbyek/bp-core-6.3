...
public class OrdermanagementaddonManager extends GeneratedOrdermanagementaddonManager
{
	...
	private static final Logger LOG = Logger.getLogger(OrdermanagementaddonManager.class.getName());
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OrdermanagementaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OrdermanagementaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
