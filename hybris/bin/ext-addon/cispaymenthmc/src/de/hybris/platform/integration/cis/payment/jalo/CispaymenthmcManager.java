...
/**
 * This is the extension manager of the Cispaymenthmc extension.
 */
public class CispaymenthmcManager extends GeneratedCispaymenthmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CispaymenthmcManager.class);
	 ...
	 */
	public static CispaymenthmcManager getInstance()
	{
		return (CispaymenthmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CispaymenthmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CispaymenthmcManager() // NOPMD 
	{
		LOG.debug("constructor of CispaymenthmcManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CispaymenthmcManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CispaymenthmcManager called, current tenant: {}", getTenant().getTenantID());
	}
