...
public class DefaultCispaymenthmcService implements CispaymenthmcService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCispaymenthmcService.class);
	...
	{
		return DefaultCispaymenthmcService.class.getResourceAsStream("/cispaymenthmc/sap-hybris-platform.png");
	}
