...
/**
 * This is the extension manager of the Stocknotificationaddon extension.
 */
public class StocknotificationaddonManager extends GeneratedStocknotificationaddonManager
{
	 ...
	 */
	public static StocknotificationaddonManager getInstance()
	{
		return (StocknotificationaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StocknotificationaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StocknotificationaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StocknotificationaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StocknotificationaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StocknotificationaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
