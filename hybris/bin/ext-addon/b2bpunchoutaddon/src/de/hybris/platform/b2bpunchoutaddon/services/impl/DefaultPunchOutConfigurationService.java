...
public class DefaultPunchOutConfigurationService implements PunchOutConfigurationService
{
	...
	protected String getPunchOutLoginAuthToken(final PunchOutSession punchoutSession)
	{
		String userId = null;
	...
	protected String getInexistenCustomerMessage(final List<Organization> organizationList)
	{
