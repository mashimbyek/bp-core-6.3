...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"ReorderAction",
			"SimpleCMSAction",
			de.hybris.platform.b2bacceleratoraddon.jalo.actions.ReorderAction.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			"ApproveOrderAction",
			"SimpleCMSAction",
			de.hybris.platform.b2bacceleratoraddon.jalo.actions.ApproveOrderAction.class,
			null,
			false,
			null,
			false
