...
import de.hybris.platform.constants.CommercesearchsamplesaddonConstants;



/**
 * This is the extension manager of the Commercesearchsamplesaddon extension.
 */
public class CommercesearchsamplesaddonManager extends GeneratedCommercesearchsamplesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CommercesearchsamplesaddonManager.class.getName());
	 ...
	 */
	public static CommercesearchsamplesaddonManager getInstance()
	{
		return (CommercesearchsamplesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CommercesearchsamplesaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CommercesearchsamplesaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CommercesearchsamplesaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CommercesearchsamplesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CommercesearchsamplesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
