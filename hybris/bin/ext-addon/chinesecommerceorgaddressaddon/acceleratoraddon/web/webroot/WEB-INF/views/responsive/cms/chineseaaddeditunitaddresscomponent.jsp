...
<%@ taglib prefix="address" tagdir="/WEB-INF/tags/addons/chinesecommerceorgaddressaddon/responsive/address"%>
...
<org-common:headline url="${cancelUrl}" labelKey="text.company.manage.units.addressForm.${empty addressData.id?'create':'edit'}.title" />
        <div class="account-section-content row">
            <form:form action="${actionUrl}" method="post" commandName="addressForm">
                <div class="clearfix">
                    <div id="unitAddressCountrySelector" class="col-xs-12 col-sm-6">
                    ...
                    <div id="i18nUnitAddressForm" class="i18nUnitAddressForm">
