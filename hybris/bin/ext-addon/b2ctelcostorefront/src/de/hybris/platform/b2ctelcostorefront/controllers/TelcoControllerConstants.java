...
*
*/
package de.hybris.platform.b2ctelcostorefront.controllers;
 ...
 */
public interface TelcoControllerConstants
{
	String ADDON_PREFIX = "addon:/b2ctelcostorefront/";
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountPaymentInfoPage = ADDON_PREFIX + "pages/account/accountPaymentInfoPage";
				String AccountPaymentMethodSubscriptionsPage = ADDON_PREFIX + "pages/account/accountPaymentMethodSubscriptionsPage";
			...
			{
				String EditComponentSolrStylePage = ADDON_PREFIX + "pages/guidedselling/editComponentSolrStylePage";
				String EditComponentAccordeonStylePage = ADDON_PREFIX + "pages/guidedselling/editComponentAccordeonStylePage";
				String ViewAllServicePlansPage = ADDON_PREFIX + "pages/guidedselling/viewAllServicePlansPage";
			}

			interface Payment
			{
				String ConfirmDeletePaymentMethodNoSubscriptions = ADDON_PREFIX + "pages/payment/paymentConfirmDeletePage";
				String RemoveAndReplacePaymentMethod = "pages/payment/paymentChangeForSubscriptions";
				String WarningExistingPaymentSubscriptions = ADDON_PREFIX + "pages/payment/paymentRemoveForwardToManageSubscriptions";
				String PaymentNotFound = ADDON_PREFIX + "pages/payment/paymentNotFoundPage";
			}
		...
		interface Fragments
		{
			...
			interface Checkout
			{
				String TermsAndConditionsPopup = "acceleratoraddon/web/webroot/WEB-INF/views/mobile"
						+ "/fragments/checkout/termsAndConditionsPopup";
				String BillingAddressForm = "addon:/b2ctelcocheckoutaddon/fragments/checkout/billingAddressForm";
			}
