...
*
*/
package de.hybris.platform.b2ctelcostorefront.jalo;
...
import de.hybris.platform.b2ctelcostorefront.constants.B2ctelcostorefrontConstants;



/**
 * This is the extension manager of the B2ctelcostorefront extension.
 */
public class B2ctelcostorefrontManager extends GeneratedB2ctelcostorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(B2ctelcostorefrontManager.class.getName());
	 ...
	 */
	public B2ctelcostorefrontManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of B2ctelcostorefrontManager called.");
		}
	}
	 ...
	 */
	public static B2ctelcostorefrontManager getInstance()
	{
		return (B2ctelcostorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				B2ctelcostorefrontConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of B2ctelcostorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of B2ctelcostorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
