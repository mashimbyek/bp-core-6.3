...
public class TextfieldconfiguratortemplateaddonManager extends GeneratedTextfieldconfiguratortemplateaddonManager
{
	...
	{
		return (TextfieldconfiguratortemplateaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TextfieldconfiguratortemplateaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TextfieldconfiguratortemplateaddonManager() // NOPMD NOSONAR
	{
