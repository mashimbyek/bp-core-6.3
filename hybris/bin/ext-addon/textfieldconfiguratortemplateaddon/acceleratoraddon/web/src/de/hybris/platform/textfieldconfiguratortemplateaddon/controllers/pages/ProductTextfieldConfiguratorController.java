...
public class ProductTextfieldConfiguratorController extends AbstractPageController
{
	...
	@RequestMapping(value = "/**/p/{productCode}/configuratorPage/" + TEXTFIELDCONFIGURATOR_TYPE, method = { RequestMethod.GET, RequestMethod.POST })
	...
	{
		return String.format("%s/p/%s/configuratorPage/%s", REDIRECT_PREFIX, productCode, TEXTFIELDCONFIGURATOR_TYPE);
	}
