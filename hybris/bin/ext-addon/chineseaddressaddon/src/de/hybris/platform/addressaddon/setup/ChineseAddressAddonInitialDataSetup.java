 ...
 */
package de.hybris.platform.addressaddon.setup;
 ...
 *
 */
@SystemSetup(extension = ChineseaddressaddonConstants.EXTENSIONNAME)
public class ChineseAddressAddonInitialDataSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChineseAddressAddonInitialDataSetup.class);
