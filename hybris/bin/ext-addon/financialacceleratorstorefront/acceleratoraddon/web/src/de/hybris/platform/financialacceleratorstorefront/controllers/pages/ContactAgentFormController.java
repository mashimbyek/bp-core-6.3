...
{
	private static final Logger LOG = Logger.getLogger(ContactAgentFormController.class);
	// CMS Pages
					...
					throws CMSItemNotFoundException, YFormServiceException, InvalidAttributeValueException
	{
		...
		if (SEND.equals(viewStatus))
		{
			...
			{
				LOG.warn(
						"Can't upload yFormData. Attribute 'financialFindAgentForm' doesn't exist in session. redirect to /find-agent.");
				return REDIRECT_PREFIX + "/find-agent";
			}
		}
