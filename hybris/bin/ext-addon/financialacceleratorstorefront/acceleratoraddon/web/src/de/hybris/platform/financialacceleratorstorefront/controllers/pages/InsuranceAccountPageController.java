...
{
	private static final Logger LOG = Logger.getLogger(InsuranceAccountPageController.class);
	// CMS Pages
	...
	@RequestMapping(value = "/my-insurance-quotes", method = RequestMethod.GET)
	@RequireHardLogIn
	...
	public void pdfPrint(@PathVariable("orderCode") final String orderCode, final HttpServletResponse response) throws IOException
	{
		...
		{
			documentGenerationFacade.generate(DocumentGenerationFacade.PDF_DOCUMENT, orderData.getInsurancePolicy().get(0),
					response);
		}
	}
