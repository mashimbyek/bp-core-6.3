...
public class ChangePlanController extends AbstractPageController
{
					...
					throws CommerceCartModificationException, IOException, ServletException
	{
		...
		if (sessionCart.getEntries() != null)
		{
			for (final OrderEntryData entryData : sessionCart.getEntries())
			{
				...
				final String queryString = StringUtils.isNotEmpty(viewStatus)
						? WebConstants.QUERY_STRING_SEPERATOR + WebConstants.QUERY_STRING_VIEWSTATUS + viewStatus : StringUtils.EMPTY;
	...
	public String removePlanInCart(final RedirectAttributes redirectModel,
