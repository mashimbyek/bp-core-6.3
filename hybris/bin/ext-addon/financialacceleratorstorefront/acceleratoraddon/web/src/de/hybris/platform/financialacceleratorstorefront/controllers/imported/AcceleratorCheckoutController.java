...
public class AcceleratorCheckoutController extends AbstractCheckoutController
{
	protected static final Logger LOG = Logger.getLogger(AcceleratorCheckoutController.class);
	/**
