...
public class YFormsBackofficeConfigExtender
{
	...
	public void removeAll()
	{
		if (MapUtils.isNotEmpty(this.contextStrategies))
		{
			this.configurationService.setContextStrategies(
					remove(this.configurationService.getContextStrategies(), this.contextStrategies, this.originalContextStrategies));
		}
		...
		if (MapUtils.isNotEmpty(this.adapters))
		{
			this.configurationService
					.setAdapters(remove(this.configurationService.getAdapters(), this.adapters, this.originalAdapters));
		}
