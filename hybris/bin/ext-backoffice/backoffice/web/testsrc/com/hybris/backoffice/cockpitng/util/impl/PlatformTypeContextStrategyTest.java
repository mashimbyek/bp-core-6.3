...
public class PlatformTypeContextStrategyTest
{
	...
	public void testCollectionType()
	{
		...
		assertThat(parentContexts).isEqualTo(
				Lists.newArrayList(ArrayList.class.getSuperclass().getName(), List.class.getName(), RandomAccess.class.getName(),
	...
	public void testMapType()
	{
		...
		assertThat(parentContexts).isEqualTo(
				Lists.newArrayList(HashMap.class.getSuperclass().getName(), Map.class.getName(), Cloneable.class.getName(),
