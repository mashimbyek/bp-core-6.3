...
public class ReferenceFilterAdvancedSearchInitializerTest
{
	...
	private final DynamicNode node = new DynamicNode("myNode", null, BigInteger.ONE);
	private final DynamicNode invalidNode = new DynamicNode("invalidNode", null, BigInteger.ONE);
