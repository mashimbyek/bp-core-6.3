...
public class DefaultCartServiceForAccelerator extends DefaultCartService
{
	...
	protected AbstractOrderEntryModel getAbstractOrderEntryModel(final CartModel order, final ProductModel product,
															   final long qty, final int number,
															   final boolean addToPresent, final UnitModel usedUnit)
	{
