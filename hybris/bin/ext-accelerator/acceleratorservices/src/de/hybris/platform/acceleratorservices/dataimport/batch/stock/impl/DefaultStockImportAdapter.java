 ...
 */
public class DefaultStockImportAdapter implements StockImportAdapter
{
	private static final Logger LOG = Logger.getLogger(DefaultStockImportAdapter.class);
	...
	public void performImport(final String cellValue, final Item product)
	{
		...
		try
		{
			...
			final int actualAmount = Integer.parseInt(values[0]);
