...
public class DefaultPickupPointOfServiceConsolidationStrategy implements PickupPointOfServiceConsolidationStrategy
{
	...
	public List<PointOfServiceDistanceData> getConsolidationOptions(final CartModel cartModel)
	{
		...
		collectPickupPoints(cartModel, potentialPickupPoints, productsForPickup);
		...
		processPotentialPickupPoints(cartModel, consolidatedPickupPoints,
				potentialPickupPoints, userLocation, productsForPickup);

		final PageableData pageableData = getPageableData();
		processPageableData(cartModel, consolidatedPickupPoints, userLocation, productsForPickup, pageableData);

		return new ArrayList<PointOfServiceDistanceData>(consolidatedPickupPoints);
	}

	protected void processPageableData(final CartModel cartModel,
									 final Set<PointOfServiceDistanceData> consolidatedPickupPoints,
									 final UserLocationData userLocation, final Set<ProductModel> productsForPickup,
	...
	protected void processPotentialPickupPoints(final CartModel cartModel,
											  final Set<PointOfServiceDistanceData> consolidatedPickupPoints,
											  final Set<PointOfServiceModel> potentialPickupPoints,
											  final UserLocationData userLocation,
											  final Set<ProductModel> productsForPickup)
	{
	...
	protected void collectPickupPoints(final CartModel cartModel, final Set<PointOfServiceModel> potentialPickupPoints,
									 final Set<ProductModel> productsForPickup)
	{
	...
	{
		return getStoreFinderService().positionSearch(
