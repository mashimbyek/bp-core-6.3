 ...
 */
package de.hybris.platform.chinaacceleratorservices.hmc;
 ...
 * @version ExtGen v4.1
 */
public class ChinaacceleratorServciesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ChinaacceleratorServciesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.chinaacceleratorservices.hmc.locales";
