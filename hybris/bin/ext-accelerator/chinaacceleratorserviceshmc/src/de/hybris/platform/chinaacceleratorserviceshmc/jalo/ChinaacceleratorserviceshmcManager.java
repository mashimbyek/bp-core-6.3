 ...
 */
package de.hybris.platform.chinaacceleratorserviceshmc.jalo;
...
import de.hybris.platform.chinaacceleratorserviceshmc.constants.ChinaacceleratorserviceshmcConstants;



/**
 * This is the extension manager of the Chinaacceleratorserviceshmc extension.
 */
public class ChinaacceleratorserviceshmcManager extends GeneratedChinaacceleratorserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ChinaacceleratorserviceshmcManager.class.getName());
	 ...
	 */
	public static ChinaacceleratorserviceshmcManager getInstance()
	{
		return (ChinaacceleratorserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ChinaacceleratorserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ChinaacceleratorserviceshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ChinaacceleratorserviceshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ChinaacceleratorserviceshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ChinaacceleratorserviceshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
