 ...
 */
package de.hybris.platform.acceleratorcmshmc.jalo;
...
import de.hybris.platform.acceleratorcmshmc.constants.AcceleratorcmshmcConstants;



/**
 * This is the extension manager of the Acceleratorcmshmc extension.
 */
public class AcceleratorcmshmcManager extends GeneratedAcceleratorcmshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AcceleratorcmshmcManager.class.getName());
	 ...
	 */
	public static AcceleratorcmshmcManager getInstance()
	{
		return (AcceleratorcmshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AcceleratorcmshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AcceleratorcmshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AcceleratorcmshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AcceleratorcmshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AcceleratorcmshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
