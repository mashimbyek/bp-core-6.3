 ...
 */
package de.hybris.platform.acceleratorcms.hmc;
 ...
 * @version ExtGen v4.1
 */
public class AcceleratorCmsHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AcceleratorCmsHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.acceleratorcms.hmc.locales";
