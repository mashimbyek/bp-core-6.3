 ...
 */
package de.hybris.platform.acceleratorfacades.futurestock.impl;
...
/**
 * Default implementation for {@link FutureStockFacade}
 */
public class DefaultFutureStockFacade implements FutureStockFacade
{
	...
	public List<FutureStockData> getFutureAvailability(final String productCode)
	{
		...
		{
			// Null is returned as a result of service being down - caller methods treat null
	 ...
	 * @param productsMap
	 */
	protected void mapMap2MapList(final List<ProductModel> products, final Map<String, List<FutureStockData>> result,
	...
	protected List<FutureStockData> futureMapAsList(final Map<Date, Integer> futureMap)
	{
	...
	protected void sortByDate(final List<FutureStockData> futureList)
	{
