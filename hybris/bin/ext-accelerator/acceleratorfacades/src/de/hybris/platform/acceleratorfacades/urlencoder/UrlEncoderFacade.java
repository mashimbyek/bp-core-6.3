...
{
	/**
	 * Gets url encoding variables
	 * 
	 * @deprecated use {@link #getCurrentUrlEncodingData()} instead
	 * @return a {@link List} of {@link UrlEncoderData}
	 */
	@Deprecated
	...
	/**
	 * Extracts url encoding pattern
	 * 
	 * @deprecated use {@link #calculateAndUpdateUrlEncodingData(String, String)} instead
	 * @param url the url
	 * @param contextPath the context path
	 * @param newSession check whether new session or user driven
	 * @return url encoding pattern
	 */
	@Deprecated
