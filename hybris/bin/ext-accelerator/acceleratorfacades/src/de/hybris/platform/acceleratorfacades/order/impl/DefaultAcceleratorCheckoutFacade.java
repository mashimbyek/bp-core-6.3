...
/**
 * Default implementation of {@link AcceleratorCheckoutFacade}
 */
public class DefaultAcceleratorCheckoutFacade extends DefaultCheckoutFacade implements AcceleratorCheckoutFacade
{
			...
			throws CommerceCartModificationException
	{
		...
		return Converters.convertAll(getAcceleratorCheckoutService().consolidateCheckoutCart(getCart(),
	...
	public boolean isExpressCheckoutAllowedForCart()
	{
		return isExpressCheckoutEnabledForStore()
				? isExpressCheckoutAllowedForShippingCart() || isExpressCheckoutAllowedPickupOnlyCart() : false;
	}
	...
	protected ExpressCheckoutResult getExpressCheckoutDeliveryResult()
	{
		if (hasShippingItems())
		{
