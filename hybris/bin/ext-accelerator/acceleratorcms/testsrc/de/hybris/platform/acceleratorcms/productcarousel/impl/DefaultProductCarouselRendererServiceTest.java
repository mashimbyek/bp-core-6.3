...
public class DefaultProductCarouselRendererServiceTest
{
	...
	@Test
	public void testGetListOfProducts_noProducts_for_productcarousel()
	{

		carouselModel.setProducts(Arrays.asList());
		when(modelService.get(PK.BIG_PK)).thenReturn(carouselModel);

		final List<ProductModel> products = defaultProductCarouselPreviewRendererService.getListOfProducts(carouselModel);
		assertTrue(products.isEmpty());

	}

	@Test
	public void testGetListOfProducts_hasProducts_for_productcarousel()
	{
		...
		final List<ProductModel> products = defaultProductCarouselPreviewRendererService.getListOfProducts(carouselModel);
		assertThat(products, containsInAnyOrder(productModel01, productModel02, productModel03));
	...
	@Test
	public void testGetListOfProducts_noProducts_for_category()
	{

		categoryModel.setProducts(Arrays.asList());
		when(modelService.get(PK.BIG_PK)).thenReturn(categoryModel);

		final List<ProductModel> products = defaultProductCarouselPreviewRendererService.getListOfProducts(categoryModel);
		assertTrue(products.isEmpty());

	}

	@Test
	public void testGetListOfProducts_hasProducts_for_category()
	{
