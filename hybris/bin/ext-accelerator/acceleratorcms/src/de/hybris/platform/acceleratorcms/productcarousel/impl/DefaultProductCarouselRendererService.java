...
public class DefaultProductCarouselRendererService implements ProductCarouselRendererService
{
	...
	{
		return retrieveProductsForVersionsInSession(getListOfProducts(component));
	}

	@Override
	public List<ProductModel> getDisplayableProducts(final CategoryModel category)
	{
		return retrieveProductsForVersionsInSession(getListOfProducts(category));
	}
	 ...
	 */
	protected List<ProductModel> getListOfProducts(final ProductCarouselComponentModel component)
	{
	 ...
	 * This is needed when the session catalog version is not the active version. This is possible through CMS tooling
	 */
	protected List<ProductModel> getListOfProducts(final CategoryModel category)
	{
