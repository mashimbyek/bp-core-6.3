...
public class CMSContentSlotTag extends BodyTagSupport implements DynamicAttributes
{
	...
	protected Collection<CMSDynamicAttributeService> cmsDynamicAttributeServices;
	...
	protected String getElementName()
	{
		...
		else
		{
			...
			final Optional<String> optional = cmsDynamicAttributeServices.stream()
					.filter(e -> e.getFallbackElement(currentContentSlot) != null).map(e -> e.getFallbackElement(currentContentSlot))
					.findFirst();
