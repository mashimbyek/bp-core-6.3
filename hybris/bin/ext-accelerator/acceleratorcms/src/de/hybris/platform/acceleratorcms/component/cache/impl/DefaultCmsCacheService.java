...
/**
 * Default implementation of {@link CmsCacheService}
 */
public class DefaultCmsCacheService implements CmsCacheService
{
	...
	protected Map<String, CmsCacheKeyProvider<? extends AbstractCMSComponentModel>> getCacheKeyProviders() // NOSONAR
	{
	...
	protected boolean isPreviewOrLiveEditEnabled(final HttpServletRequest request)
	{
		final CmsPageRequestContextData cmsPageRequestContextData = SpringHelper
				.getSpringBean(request, "cmsPageContextService", CMSPageContextService.class, true)
