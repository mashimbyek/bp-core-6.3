...
public class DefaultOrderEntryOverridingPopulatorTest
{
	...
	@Mock
	private Populator<Tax, Collection<TaxValue>> taxValuePopulator; // NOPMD
	...
	public void setUp()
	{
		...
		when(itemId.getSupplierPartID()).thenReturn(supplierPartId);
		when(supplierPartId.getvalue()).thenReturn(SUPPLIER_PART_ID);
