...
public class PunchOutOrderMessageProcessingActionTest
{
	...
	public void shouldCreateThePunchOutTransaction()
	{
		...
		assertThat(punchOutOrder.getPunchOutOrderMessageHeader().getTotal().getMoney().getvalue(),
				is(String.valueOf(cartModel.getTotalPrice())));
		assertThat(punchOutOrder.getPunchOutOrderMessageHeader().getTotal().getMoney().getCurrency(),
				is(String.valueOf(cartModel.getCurrency().getIsocode())));
	}
}
