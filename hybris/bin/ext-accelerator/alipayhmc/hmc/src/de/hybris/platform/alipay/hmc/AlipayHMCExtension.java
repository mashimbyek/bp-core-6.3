 ...
 */
package de.hybris.platform.alipay.hmc;
 ...
 * @version ExtGen v4.1
 */
public class AlipayHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AlipayHMCExtension.class.getName());
