 ...
 */
package de.hybris.platform.alipayhmc.jalo;
...
import de.hybris.platform.alipayhmc.constants.AlipayhmcConstants;



/**
 * This is the extension manager of the Alipayhmc extension.
 */
public class AlipayhmcManager extends GeneratedAlipayhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AlipayhmcManager.class.getName());
	 ...
	 */
	public static AlipayhmcManager getInstance()
	{
		return (AlipayhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AlipayhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AlipayhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AlipayhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AlipayhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AlipayhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
