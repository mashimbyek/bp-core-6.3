...
/**
 * @deprecated use {@link de.hybris.platform.b2b.dao.impl.DefaultPagedB2BCustomerDao} instead.
 */
@Deprecated
		...
		PagedB2BCustomerDao<B2BCustomerModel>
{
	...
	@Override
	public SearchPageData<B2BCustomerModel> findPagedCustomersForUnit(final String sortCode, final PageableData pageableData,
			final String unit)
	{
		final Map<String, Object> queryParams = new HashMap<String, Object>(2);
		queryParams.put("unit", unit);
