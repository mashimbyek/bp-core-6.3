 ...
 */
package de.hybris.platform.acceleratorserviceshmc.jalo;
...
import de.hybris.platform.acceleratorserviceshmc.constants.AcceleratorserviceshmcConstants;



/**
 * This is the extension manager of the Acceleratorserviceshmc extension.
 */
public class AcceleratorserviceshmcManager extends GeneratedAcceleratorserviceshmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AcceleratorserviceshmcManager.class.getName());
	 ...
	 */
	public static AcceleratorserviceshmcManager getInstance()
	{
		return (AcceleratorserviceshmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AcceleratorserviceshmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AcceleratorserviceshmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AcceleratorserviceshmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AcceleratorserviceshmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AcceleratorserviceshmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
