 ...
 */
package de.hybris.platform.acceleratorservices.hmc;
...
/**
 * Provides necessary meta information about the AcceleratorServices hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AcceleratorServicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AcceleratorServicesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "de.hybris.platform.acceleratorservices.hmc.locales";
