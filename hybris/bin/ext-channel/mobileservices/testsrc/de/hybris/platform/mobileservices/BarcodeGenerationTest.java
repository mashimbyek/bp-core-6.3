...
{
	private static final Logger LOG = Logger.getLogger(BarcodeGenerationTest.class.getName());
	...
	public void setUp() throws Exception
	{
		...
		try (final InputStream stream = MobileManager.class.getResourceAsStream("/sampledata/mobile.deeplinkurl.csv"))
		{
			ImpExManager.getInstance().importData(stream, encoding, CSVConstants.HYBRIS_FIELD_SEPARATOR,
