...
function loadCustomer360Fragment(sectionId,fragmentId,contentDivId,timeout)
{
	  var method = "GET";
	    return $.ajax({
	        url: ACC.config.encodedContextPath + "/assisted-service-aif/customer360Fragment?sectionId="+sectionId+"&fragmentId="+fragmentId,
	        timeout:timeout,
	        type: method,
	        success: function(data)
	        {
	        ...
	        error: function(xht, textStatus, ex)
	        {
	        	...
	        	else
	        	{
	        		...
	        		$( "#"+contentDivId).html("Faild to get widget data!");
	        	}           
	        }
	    });
}
