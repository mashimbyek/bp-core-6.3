...
public abstract class AbstractRelationModifictionContextIntegrationTest extends ServicelayerBaseTest
{
	...
	@Test
	public void shouldNotFailOnRemovingExistingLinkWhenOptimisticLockingIsEnabledAndVersionDoesntMatch() throws Exception
	{
		doWithOptimisticLockingEnabled(new RunnableWithException()
		{
			@Override
	...
	@Test
	public void shouldNotFailOnRemovingExistingLinkWhenOptimisticLockingIsDisabledAndVersionDoesntMatch() throws Exception
	{
		doWithOptimisticLockingEnabled(new RunnableWithException()
		{
			@Override
