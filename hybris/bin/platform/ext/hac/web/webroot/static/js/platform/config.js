$(function() {
	...
	$(".configValue").live("blur", function(e){
	...
	$("img.applyIconHighOpac").live('click', function(e) {
		...
		var configValue = input.attr('value');
        var token = $("meta[name='_csrf']").attr("content");
			...
			success : function(data) {
				...
				if(newProps){
					$.each(newProps, function(key, value){
						var node = table.fnAddData([key,
						   getTDContentValue(key, value) ]);
