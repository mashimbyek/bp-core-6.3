...
public class MediaModel extends AbstractMediaModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(CONVERTEDMEDIAS);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(METADATADATAPK);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(ORIGINALDATAPK);
	}
	...
	{
		getPersistenceContext().setPropertyValue(CONVERTEDMEDIAS, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(METADATADATAPK, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(ORIGINALDATAPK, value);
	}
